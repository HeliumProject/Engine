...
namespace Helium
{
    ...
    /// @see Create()
    template< typename JobType >
    void JobContext::Attach( JobType* pJob )
    {
        HELIUM_ASSERT( pJob );
        HELIUM_ASSERT( !m_attachData.GetData() );
    ...
    ///
    /// @see Create()
    void JobContext::Attach( const AttachData& rAttachData )
    {
        HELIUM_ASSERT( !m_attachData.GetData() );
    ...
    const JobContext::AttachData& JobContext::GetAttachData() const
    {
        return m_attachData;
    }

    /// Constructor.
    JobContext::AttachData::AttachData()
        : m_pData( NULL )
    ...
    template< typename JobType >
    JobContext::AttachData::AttachData( JobType* pJob )
        : m_pData( pJob )
    ...
    template< typename JobType >
    void JobContext::AttachData::Set( JobType* pJob )
    {
        HELIUM_ASSERT( pJob );
    ...
    ///
    /// @see Clear(), GetData(), GetExecuteCallback()
    void JobContext::AttachData::Set( void* pData, JOB_EXECUTE_CALLBACK* pExecuteCallback )
    {
        HELIUM_ASSERT( pData );
    ...
    void JobContext::AttachData::Clear()
    {
        m_pData = NULL;
        m_pExecuteCallback = NULL;
    }
    ...
    void* JobContext::AttachData::GetData() const
    {
        return m_pData;
    }
    ...
    JobContext::JOB_EXECUTE_CALLBACK* JobContext::AttachData::GetExecuteCallback() const
    {
    ...
    JobContext::Spawner< ChildCountMax >::Spawner( JobContext* pContext )
        : m_pContext( pContext )
    ...
    /// Destructor.
    template< size_t ChildCountMax >
    JobContext::Spawner< ChildCountMax >::~Spawner()
    {
        Commit();
    }
    ...
    template< size_t ChildCountMax >
    JobContext* JobContext::Spawner< ChildCountMax >::Allocate()
    {
    ...
    /// @see Allocate(), Commit()
    template< size_t ChildCountMax >
    JobContext* JobContext::Spawner< ChildCountMax >::AllocateContinuation()
    {
    ...
    template< size_t ChildCountMax >
    void JobContext::Spawner< ChildCountMax >::Commit()
    {
