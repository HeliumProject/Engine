...
const Math::Axis SideAxis = Math::SingleAxes::X;
const Math::Vector3 SideVector (1.f, 0.f, 0.f);

const Math::Axis OutAxis = Math::SingleAxes::Z;
const Math::Vector3 OutVector (0.f, 0.f, 1.f);

const Math::Axis UpAxis = Math::SingleAxes::Y;
const Math::Vector3 UpVector (0.f, 1.f, 0.f);
...
const Math::Axis SideAxis = Math::SingleAxes::Y;
const Math::Vector3 SideVector (0.f, 1.f, 0.f);

const Math::Axis OutAxis = Math::SingleAxes::X;
const Math::Vector3 OutVector (1.f, 0.f, 0.f);

const Math::Axis UpAxis = Math::SingleAxes::Z;
const Math::Vector3 UpVector (0.f, 0.f, 1.f);
