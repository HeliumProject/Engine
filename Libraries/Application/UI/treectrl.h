...
WX_DECLARE_VOIDPTR_HASH_MAP_WITH_DECL(wxTreeItemAttr *, MapTreeAttr, class APPLICATION_API);
...
class APPLICATION_API TreeCtrl : public wxTreeCtrlBase
{
public:
    // creation
    // --------
    ...
    TreeCtrl(wxWindow *parent, wxWindowID id = wxID_ANY,
...
private:
    ...
    // helper functions
    bool DoGetItem(TreeViewItem *tvItem) const;
    void DoSetItem(TreeViewItem *tvItem);
    ...
    DECLARE_NO_COPY_CLASS(TreeCtrl)
};
