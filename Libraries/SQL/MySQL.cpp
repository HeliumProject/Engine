...
// Default constructor
//
MySQL::MySQL( const char* friendlyName )
...
/////////////////////////////////////////////////////////////////////////////
const char* MySQL::GetErrorString()
{
...
//  \#define {[A-Z_]+}{[ ]+}{:z+}{ \/\/ }{.*}
//  case \1:\2\/\/ \3 \5\nerrCodeString = "\1";\nbreak;\n
void MySQL::ErrorCodeToString( const int errorCode, std::string& errorString )
{
  switch( errorCode )
  {
  default:
