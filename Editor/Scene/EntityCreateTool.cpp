...
{
    Reflect::RegisterClass< Editor::EntityCreateTool >( TXT( "Editor::EntityCreateTool" ) );
}

void EntityCreateTool::CleanupType()
{
    Reflect::UnregisterClass< Editor::EntityCreateTool >();
}

EntityCreateTool::EntityCreateTool(Editor::Scene* scene, PropertiesGenerator* generator)
...
Editor::TransformPtr EntityCreateTool::CreateNode()
{
    ...
    try
    {
        ...
        EntityPtr entity = new Editor::Entity (m_Scene, new Asset::EntityInstance( entityClassPath.Get() ) );
...
void EntityCreateTool::CreateProperties()
{
    m_Generator->PushPanel( TXT( "Entity" ), true);
    {
        ...
        {
            m_FileButton = m_Generator->AddFileDialogButton< tstring >( new Helium::MemberProperty<Editor::EntityCreateTool, tstring> (this, &EntityCreateTool::GetEntityAsset, &EntityCreateTool::SetEntityAsset ) );
            m_BrowserButton = m_Generator->AddFileBrowserButton< tstring >( new Helium::MemberProperty<Editor::EntityCreateTool, tstring> (this, &EntityCreateTool::GetEntityAsset, &EntityCreateTool::SetEntityAsset ) );

            m_FileButtonAdd = m_Generator->AddFileDialogButton< tstring >( new Helium::MemberProperty<Editor::EntityCreateTool, tstring> (this, &EntityCreateTool::GetEntityAsset, &EntityCreateTool::AddEntityAsset ) );
            m_BrowserButtonAdd = m_Generator->AddFileBrowserButton< tstring >( new Helium::MemberProperty<Editor::EntityCreateTool, tstring> (this, &EntityCreateTool::GetEntityAsset, &EntityCreateTool::AddEntityAsset ) );
        ...
        m_Generator->PushContainer();
        {
            m_RandomEntityList = m_Generator->AddList< tstring >( new Helium::MemberProperty<Editor::EntityCreateTool, tstring > (this, &EntityCreateTool::GetRandomEntity, &EntityCreateTool::SetRandomEntity) );
        ...
        m_Generator->PushContainer();
        {
            ...
            m_Generator->AddCheckBox<bool>( new Helium::MemberProperty<Editor::EntityCreateTool, bool> (this, &EntityCreateTool::GetPointerVisible, &EntityCreateTool::SetPointerVisible) );
        }
        m_Generator->Pop();
        ...
        m_Generator->PushContainer();
        {
            ...
            m_Generator->AddCheckBox<bool>( new Helium::MemberProperty<Editor::EntityCreateTool, bool> (this, &EntityCreateTool::GetBoundsVisible, &EntityCreateTool::SetBoundsVisible) );
        }
        m_Generator->Pop();
        ...
        m_Generator->PushContainer();
        {
            ...
            m_Generator->AddCheckBox<bool>( new Helium::MemberProperty<Editor::EntityCreateTool, bool> (this, &EntityCreateTool::GetGeometryVisible, &EntityCreateTool::SetGeometryVisible) );
        }
        m_Generator->Pop();
...
{
    Editor::EntityCreateTool* thisTool = Reflect::ObjectCast< Editor::EntityCreateTool >( button->GetClientData() );
    if ( !thisTool )
    {
