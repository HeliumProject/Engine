...
namespace Luna
{
  ...
  typedef Nocturnal::Signature< bool, const OS_SelectableDumbPtr& > SelectionChangingSignature;
  typedef Nocturnal::Signature< void, const OS_SelectableDumbPtr& > SelectionChangedSignature;
  ...
  private:
    ...
    public:
      SelectionChangeCommand( Selection* selection )
        : Undo::PropertyCommand< OS_SelectableDumbPtr >( new Nocturnal::MemberProperty< Selection, OS_SelectableDumbPtr > (selection, &Selection::GetUndo, &Selection::SetUndo) )
      {
