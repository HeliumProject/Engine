...
namespace Nocturnal
{
    namespace UID
    {
        ...
        public:
            ...
            friend UID_API std::ostream& operator<<(std::ostream& stream, const TUID& id);
            friend UID_API std::istream& operator>>(std::istream& stream, TUID& id);
        };
        ...
        UID_API inline std::ostream& operator<<(std::ostream& stream, const TUID& id)
        {
            std::string s;
            id.ToString(s);
            stream << s;
        ...
        UID_API inline std::istream& operator>>(std::istream& stream, TUID& id)
        {
            std::string s;
            stream >> s;
    ...
    template<> inline void Swizzle<UID::TUID>(UID::TUID& val, bool swizzle)
    {
