...
namespace MayaContent
{
  ...
  struct MAYA_CONTENT_API VertexIndex
  {
    u32   m_Index;
    bool  m_Wire;
  ...
  struct MAYA_CONTENT_API WireEdge
  {
    int m_A;
    int m_B;
  ...
  class MAYA_CONTENT_API ExportVertex : public Nocturnal::RefCountBase<ExportVertex>
  {
  public:
    u32 m_ShaderIndex;
  ...
  class MAYA_CONTENT_API ExportTriangle
  {
  public:
    u32             m_Index;
  ...
  struct MAYA_CONTENT_API ExportPolygon
  {
    int m_Shader;
    int m_PolygonNumber;
    int m_FirstIndex;
  ...
  struct MAYA_CONTENT_API ExportMorphTargetDelta
  {
    u32           m_VertexIndex;
  ...
  struct MAYA_CONTENT_API MayaSkinCluster
  {
  ...
  struct MAYA_CONTENT_API MayaJointCluster
  {
  ...
  class MAYA_CONTENT_API ExportMesh : public ExportBase
  {
  public:
