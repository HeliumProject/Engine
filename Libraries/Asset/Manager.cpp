...
//#include "UpdateRenameAssetVisitor.h"
...
void GetRelatedFiles( ManagedAssetFile* managedAssetFile )
{
  for each ( const RelatedFile& info in g_RelatedFiles )
  {
    std::string file = GetRelatedFilePath( managedAssetFile->m_File->m_Path, info.m_Spec, info.m_Type );
    ...
    if ( FileSystem::Exists( file ) )
    {
      ...
      {
        newFile = GetRelatedFilePath( managedAssetFile->m_NewFile->m_Path, info.m_Spec, info.m_Type );
      }
...
/////////////////////////////////////////////////////////////////////////////
void Manager::GetManagedAssetRelatedFiles( ManagedAsset* managedAsset )
{
...
//
void Manager::GetManagedAssetShaders( AssetClass* assetClass, S_tuid& shaderIDs )
{
//...
}
...
//
void Manager::ListMayaFiles( const tuid id )
{
...
void Manager::ListStaticContentFiles( const tuid id )
{
...
void Manager::GetStaticContentFiles( const tuid id, V_string& staticContentFiles )
{
  File::S_ManagedFilePtr mayaFiles;
  V_string mayaPaths;
...
///////////////////////////////////////////////////////////////////////////////
void Manager::FindMayaFiles( const S_tuid& fileIdSet, bool recurse, File::S_ManagedFilePtr& mayaFiles )
{
  ...
  while( !fileIds.empty() )
  {
    ...
    for each( const tuid fileID in fileIdsForThisPass )
    {
      ...
      if ( !file.ReferencesObject() || !FileSystem::Exists( file->m_Path ) )
      {
        continue;
      }
...
/////////////////////////////////////////////////////////////////////////////
void Manager::GetManagedFolderRelatedFiles( ManagedFolder* managedFolder )
{
...
/////////////////////////////////////////////////////////////////////////////
void Manager::GetManagedAsset( ManagedAsset* managedAsset, bool getRelatedFiles )
{
...
// all related files.
//
void Manager::GetManagedFolder( ManagedFolder* managedFolder, bool getRelatedFiles )
{
...
bool Manager::ValidateAssetOperation( ManagedAsset* managedAsset, std::string& errMsg )
{
...
void Manager::ProcessRenameAsset( ManagedAsset* managedAsset, const File::ManagerConfig managerConfig, bool rename )
{
  M_string moveFiles;
...
/////////////////////////////////////////////////////////////////////////////
// takes the asset, M_RenameElement and new path; moves the asset, all of the files in the renameElements   
void Manager::UpdateRenameAsset( ManagedAsset* managedAsset, bool rename )
{
...
/////////////////////////////////////////////////////////////////////////////
void Manager::ProcessDuplicateAsset( ManagedAsset* managedAsset, const File::ManagerConfig managerConfig )
{
...
/////////////////////////////////////////////////////////////////////////////
Asset::AssetClassPtr Manager::UpdateDuplicateAsset( ManagedAsset* managedAsset )
{
...
/////////////////////////////////////////////////////////////////////////////
// validates that the new paths are not already in the Resolver
void Manager::ProcessDeleteAsset( ManagedAsset* managedAsset, const File::ManagerConfig managerConfig )
{
...
{ 
  ...
  OperationFlag opFlags = Manager::OperationFlags::Duplicate;
  ...
  if ( getShaderUsages )
  {
    ...
    {
      S_tuid shaderIDs;
      GetManagedAssetShaders( assetClass, shaderIDs );
...
//
void Manager::MigrateFile( const File::ManagedFilePtr& sourceAssetFile, File::Manager* sourceManager, const File::ManagerConfig managerConfig )
{
