...
Viewport::Viewport( HWND wnd, SettingsManager* settingsManager, WorldPtr world )
: m_Window( wnd )
...
void Viewport::OnResize()
{
    ...
    if (m_World.Get())
    {
        ...
        GraphicsScene* pGraphicsScene = m_World->GetGraphicsScene(); //m_EditorSlice->GetWorld()->GetGraphicsScene();
