...
namespace Lunar
{
    ...
    size_t StringConverter< char, wchar_t >::Convert(
        wchar_t* pDestString,
    ...
    bool StringConverter< char, wchar_t >::Convert(
    ...
    size_t StringConverter< wchar_t, char >::Convert(
        char* pDestString,
        size_t destBufferSize,
    ...
    /// @return  True if the conversion was successful, false if not.
    template< typename DestAllocator >
    bool StringConverter< wchar_t, char >::Convert(
    ...
    size_t NullStringConverter< CharType >::Convert(
    ...
    template< typename CharType >
    template< typename DestAllocator >
    bool NullStringConverter< CharType >::Convert(
