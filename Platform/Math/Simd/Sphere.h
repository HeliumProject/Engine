...
namespace Helium
{
    namespace Simd
    {
        ...
        HELIUM_ALIGN_PRE( 16 ) class PLATFORM_API Sphere
        {
        public:
...
#include "Platform/Math/Simd/Sphere.inl"

#if HELIUM_SIMD_LRBNI
#include "Platform/Math/Simd/Lrbni/Sphere.inl"
#elif HELIUM_SIMD_SSE
#include "Platform/Math/Simd/Sse/Sphere.inl"
#endif
