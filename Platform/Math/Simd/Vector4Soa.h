...
namespace Helium
{
    namespace Simd
    {
        ...
        HELIUM_SIMD_ALIGN_PRE class PLATFORM_API Vector4Soa
        {
        public:
            /// X components.
            Register m_x;
...
#include "Platform/Math/Simd/Vector4Soa.inl"

#if HELIUM_SIMD_LRBNI
#include "Platform/Math/Simd/Lrbni/Vector4Soa.inl"
#elif HELIUM_SIMD_SSE
#include "Platform/Math/Simd/Sse/Vector4Soa.inl"
#endif
