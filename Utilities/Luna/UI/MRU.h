...
namespace Luna
{
  ...
  //
  template<class T>
  class LUNA_CORE_API MRU : public Nocturnal::RefCountBase< MRU<T> >
  {
  public:
  ...
  typedef LUNA_CORE_API MRU< std::string > ManagedStringSet;
  typedef LUNA_CORE_API Nocturnal::SmartPtr< ManagedStringSet > ManagedStringSetPtr;
