...
#define IS_VIRTUAL_ROOT(item) (HITEM(item) == TVI_ROOT)
    ...
    public:
        ...
        virtual bool OnVisit(const wxTreeItemId& item)
        {
            ...
            if ( Nocturnal::IsItemSelected(GetHwndOf(tree), HITEM(item)) )
            {
    ...
    */
    ...
    void TreeCtrl::UnselectAll()
    {
        ...
        {
            bool sendChangedEvent = Nocturnal::TryUnselectAll( this );
    ...
    WXLRESULT TreeCtrl::MSWWindowProc(WXUINT nMsg, WXWPARAM wParam, WXLPARAM lParam)
    {
        ...
        else if ( (nMsg >= WM_MOUSEFIRST) && (nMsg <= WM_MOUSELAST) )
        {
            ...
            case WM_RBUTTONDOWN:
                ...
                if ( !htItem || !Nocturnal::IsItemSelected(GetHwnd(), htItem) )
                {
                    UnselectAll();
                }
                ...
                // newly selected item
                if ( !Nocturnal::IsItemSelected( GetHwnd(), htItem ) )
                {
                    if ( isMultiple )
                    {
                        if ( htItem )
                ...
                if ( isMultiple )
                {
                    ...
                    if ( htItem && tvht.flags & TVHT_ONITEM ) 
                    {
                        ...
                        if ( wParam & MK_SHIFT )
                        {
                            ...
                            {
                                // Select range
                                Nocturnal::SelectRange( GetHwnd(), this, HITEM( m_htSelStart ), htItem );
                            }
                        }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    Nocturnal::TryUnselectAll( this ); // Does not fire the "changed" event
