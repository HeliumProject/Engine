...
namespace AssetBuilder
{
  ...
  struct PIPELINE_API BuildJob : public Nocturnal::RefCountBase<BuildJob>
  {
  ...
  class PIPELINE_API IBuilder : public Nocturnal::RefCountBase<IBuilder>
  {
  public:
    virtual ~IBuilder()
    {
...
namespace BuilderInterface
{
  ...
  PIPELINE_API void AllocateBuilders( Asset::AssetType assetType, AssetBuilder::V_IBuilder& builders );
}
