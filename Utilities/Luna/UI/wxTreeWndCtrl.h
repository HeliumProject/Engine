...
class LUNA_CORE_API wxTreeWndCtrlItem;

// ----------------------------------------------------------------------------
// globals
// ----------------------------------------------------------------------------

LUNA_CORE_API extern const wxTreeItemId wxTreeWndCtrlItemIdInvalid;
LUNA_CORE_API extern wxBitmap wxTreeWndCtrlDefaultExpand;
LUNA_CORE_API extern wxBitmap wxTreeWndCtrlDefaultCollapse;
LUNA_CORE_API extern wxPen wxTreeWndCtrlDefaultPen;

// ----------------------------------------------------------------------------
// wxTreeWndCtrl
// ----------------------------------------------------------------------------

class LUNA_CORE_API wxTreeWndCtrl : public wxScrolledWindow
{
