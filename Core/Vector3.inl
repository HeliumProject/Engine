...
namespace Lunar
{
    ...
    Vector3 Vector3::Add( const Vector3& rVector ) const
    {
        Vector3 result;
    ...
    Vector3 Vector3::Subtract( const Vector3& rVector ) const
    {
        Vector3 result;
    ...
    Vector3 Vector3::Multiply( const Vector3& rVector ) const
    {
        Vector3 result;
    ...
    Vector3 Vector3::Divide( const Vector3& rVector ) const
    {
        Vector3 result;
    ...
    ///
    /// @see Scale()
    Vector3 Vector3::GetScaled( float32_t scale ) const
    {
        Vector3 result;
    ...
    ///
    /// @see GetScaled()
    void Vector3::Scale( float32_t scale )
    {
    ...
    float32_t Vector3::GetMagnitudeSquared() const
    {
        return Dot( *this );
    }
    ...
    ///
    /// @see Normalize()
    Vector3 Vector3::GetNormalized( float32_t epsilon ) const
    {
        Vector3 result = *this;
    ...
    ///
    /// @return  Copy of this vector scaled by the specified amount.
    Vector3 Vector3::operator*( float32_t scale ) const
    {
    ...
    ///
    /// @return  Reference to this vector.
    Vector3& Vector3::operator*=( float32_t scale )
    {
        Scale( scale );
