...
{
	///////////////////////////////////////////////////////////////////////////////
	/// Class BrowserFrameGenerated
	///////////////////////////////////////////////////////////////////////////////
	class BrowserFrameGenerated : public Frame
	{
		private:
		...
		public:
			BrowserFrameGenerated( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Asset Vault"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,300 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
			~BrowserFrameGenerated();
	...
	class PreviewPanelGenerated : public wxPanel 
	{
		...
		public:
			Luna::BrowserPreviewWindow* m_PreviewWindow;
			wxTextCtrl* m_Label;
