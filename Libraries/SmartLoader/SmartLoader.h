...
#pragma warning(default:4200)
  ...
  // Loading API
  //
  SMARTLOADER_API bool LoadChunkHeaders( ChunkFile& chunk_file, void* data, u32 data_size );
  SMARTLOADER_API bool ParseChunkedData( ChunkFile& chunk_file, void* data, u32 data_size, void* data_to_fixup, u32 data_to_fixup_size );
  SMARTLOADER_API bool ParseChunkedData( ChunkFile& chunk_file, void* data, u32 data_size );
  SMARTLOADER_API bool FindChunkHeader( const ChunkFile& chunk_file, ChunkHeader*& chunk_header, u32 chunk_type );
}
