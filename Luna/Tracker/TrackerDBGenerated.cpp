...
void TrackedFileProperties::link(const litesql::Database& db, const Luna::TrackedFile& o0, const Luna::TrackedProperty& o1, tstring mValue) {
    Record values;
    Split fields;
...
void TrackedFileProperties::unlink(const litesql::Database& db, const Luna::TrackedFile& o0, const Luna::TrackedProperty& o1, tstring mValue) {
...
template <> litesql::DataSource<Luna::TrackedFile> TrackedFileProperties::get(const litesql::Database& db, const litesql::Expr& expr, const litesql::Expr& srcExpr) {
    SelectQuery sel;
    sel.source(table__);
    sel.result(TrackedFile.fullName());
    sel.where(srcExpr);
    return DataSource<Luna::TrackedFile>(db, Luna::TrackedFile::Id.in(sel) && expr);
}
template <> litesql::DataSource<Luna::TrackedProperty> TrackedFileProperties::get(const litesql::Database& db, const litesql::Expr& expr, const litesql::Expr& srcExpr) {
    SelectQuery sel;
    sel.source(table__);
    sel.result(TrackedProperty.fullName());
    sel.where(srcExpr);
    return DataSource<Luna::TrackedProperty>(db, Luna::TrackedProperty::Id.in(sel) && expr);
}
...
void FileReferences::link(const litesql::Database& db, const Luna::TrackedFile& o0, const Luna::TrackedFile& o1) {
    Record values;
    Split fields;
...
void FileReferences::unlink(const litesql::Database& db, const Luna::TrackedFile& o0, const Luna::TrackedFile& o1) {
...
litesql::DataSource<Luna::TrackedFile> FileReferences::getTrackedFile1(const litesql::Database& db, const litesql::Expr& expr, const litesql::Expr& srcExpr) {
    SelectQuery sel;
    sel.source(table__);
    sel.result(TrackedFile1.fullName());
    sel.where(srcExpr);
...
litesql::DataSource<Luna::TrackedFile> FileReferences::getTrackedFile2(const litesql::Database& db, const litesql::Expr& expr, const litesql::Expr& srcExpr) {
    SelectQuery sel;
    sel.source(table__);
    sel.result(TrackedFile2.fullName());
    sel.where(srcExpr);
