...
namespace Helium
{
    class HELIUM_FOUNDATION_API Vector2
    {
    public:
        float32_t x, y;
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const Vector2& v);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, Vector2& v);
    };
