  ...
  : wxFrame( parent, -1, title.c_str(), wxPoint( xpos, ypos ), wxSize( width, height ), wxCAPTION|wxMINIMIZE_BOX|wxMAXIMIZE_BOX|wxRESIZE_BORDER|wxSYSTEM_MENU|wxCLIP_CHILDREN  )
{
  ...
  iconBundle.AddIcon( wxArtProvider::GetIcon( Editor::ArtIDs::TaskWindow, wxART_OTHER, wxSize( 32, 32 ) ) );
  iconBundle.AddIcon( wxArtProvider::GetIcon( Editor::ArtIDs::TaskWindow ) );
  SetIcons( iconBundle );
