...
ToolsPanelGenerated::ToolsPanelGenerated( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_ButtonCreateEntity = new Nocturnal::Button( this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( -1,-1 ), wxBU_AUTODRAW );
	bSizer10->Add( m_ButtonCreateEntity, 0, wxALL, 0 );
	
	m_ButtonCreateVolume = new Nocturnal::Button( this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( -1,-1 ), wxBU_AUTODRAW );
	bSizer10->Add( m_ButtonCreateVolume, 0, wxALL, 0 );
	
	m_ButtonCreateClue = new Nocturnal::Button( this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( -1,-1 ), wxBU_AUTODRAW );
	bSizer10->Add( m_ButtonCreateClue, 0, wxALL, 0 );
	
	m_ButtonCurve = new Nocturnal::MenuButton( this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( -1,-1 ), wxBU_AUTODRAW );
