...
namespace Luna
{
  ...
  typedef std::vector< Luna::SceneNode* > V_SceneNodeDumbPtr;
  ...
  typedef stdext::hash_map< UniqueID::TUID, Luna::SceneNode*, UniqueID::TUIDHasher > HM_SceneNodeDumbPtr;
  typedef stdext::hash_map< UniqueID::TUID, SceneNodePtr, UniqueID::TUIDHasher > HM_SceneNodeSmartPtr;
  ...
  struct SceneNodeChangeArgs
  {
    ...
    SceneNodeChangeArgs( Luna::SceneNode* node )
      : m_Node( node )
    {
  ...
  //
  // Scene Node
  //  Luna application object that can have a dependencies on other objects.
  ...
  class LUNA_SCENE_API SceneNode NOC_ABSTRACT : public Persistent
  {
    //
    // Members
    //
  ...
  protected:
    ...
    // See Luna::CreateTool for more information.
    bool m_IsTransient;
  ...
  public:
    LUNA_DECLARE_TYPE( Luna::SceneNode, Persistent );
    ...
    SceneNode( Luna::Scene* scene, Content::SceneNode* data );
    virtual ~SceneNode();
    ...
    Luna::SceneNodeType* GetNodeType() const
    {
      return m_NodeType;
    }

    void SetNodeType(Luna::SceneNodeType* type)
    {
      m_NodeType = type;
    }
    ...
    const Luna::Scene* GetScene() const
    {
      return m_Scene;
    }
  ...
  public:
    virtual const UniqueID::TUID& SceneNode::GetID() const;
    virtual void SceneNode::SetID(const UniqueID::TUID& id);
  ...
  protected:
    virtual void ConnectDescendant( Luna::SceneNode* descendant );
    virtual void DisconnectDescendant( Luna::SceneNode* descendant );

    virtual void ConnectAncestor( Luna::SceneNode* ancestor );
    virtual void DisconnectAncestor( Luna::SceneNode* ancestor );
  ...
  public:
    void CreateDependency(Luna::SceneNode* ancestor);
    void RemoveDependency(Luna::SceneNode* ancestor);
  ...
  public:
    ...
    virtual void ChangeNodeType( Luna::SceneNodeType* type );

    // take a stab at deducing what node type you should be
    virtual Luna::SceneNodeType* DeduceNodeType();
