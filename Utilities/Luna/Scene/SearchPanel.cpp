...
#include "LSearchPanel.h"

///////////////////////////////////////////////////////////////////////////
using namespace Luna;

LSearchPanel::LSearchPanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_EngineType = new wxComboBox( m_TextPanel, wxID_ANY, wxT("Any"), wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY );
