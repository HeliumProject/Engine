...
namespace Nocturnal
{
    ...
    class APPLICATION_API TreeWndCtrlItem;

    // ----------------------------------------------------------------------------
    // globals
    // ----------------------------------------------------------------------------

    APPLICATION_API extern const wxTreeItemId TreeWndCtrlItemIdInvalid;
    APPLICATION_API extern wxBitmap TreeWndCtrlDefaultExpand;
    APPLICATION_API extern wxBitmap TreeWndCtrlDefaultCollapse;
    APPLICATION_API extern wxPen TreeWndCtrlDefaultPen;

    // ----------------------------------------------------------------------------
    // TreeWndCtrl
    // ----------------------------------------------------------------------------

    class APPLICATION_API TreeWndCtrl : public wxScrolledWindow
    {
