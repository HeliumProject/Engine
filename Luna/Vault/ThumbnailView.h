...
namespace Luna
{
    ...
    public:
        ThumbnailView( const tstring& thumbnailDirectory, VaultFrame *browserFrame, wxWindow *parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxNO_BORDER | wxFULL_REPAINT_ON_RESIZE | wxVSCROLL, const wxString& name = wxT( "Luna::ThumbnailView" ) );
