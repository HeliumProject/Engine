namespace Helium
{
    ...
    size_t MeshComponent::GetOverrideMaterialCount() const
    {
    ...
    Material* MeshComponent::GetOverrideMaterial( size_t index ) const
    {
    ...
    Material* MeshComponent::GetMaterial( size_t index ) const
    {
