...
namespace Content
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  class CONTENT_API MorphTargetDelta : public Reflect::Element
  {
  public: 
  ...
  /////////////////////////////////////////////////////////////////////////////
  class CONTENT_API MorphTarget : public Reflect::Element
  {
  public:
    std::string         m_Name;
    UniqueID::TUID        m_Id;
    ...
    MorphTarget( const std::string& name, const UniqueID::TUID& id )
      : m_Name( name )
      , m_Id( id )
    {
    }
  ...
  //
  class CONTENT_API Mesh : public PivotTransform
  {
  public:
    enum MeshOriginType
    {
