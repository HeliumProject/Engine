...
namespace Helium
{
    namespace Simd
    {
        ...
        HELIUM_ALIGN_PRE( 16 ) class PLATFORM_API Vector4
        {
        public:
...
#include "Platform/Math/Simd/Vector4.inl"

#if HELIUM_SIMD_LRBNI
#include "Platform/Math/Simd/Lrbni/Vector4.inl"
#elif HELIUM_SIMD_SSE
#include "Platform/Math/Simd/Sse/Vector4.inl"
#endif
