...
, m_PropertyManager ( propertiesManager )
{
  ...
  m_Intersection->Connect( m_Intersection->GetId(), wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( SelectionPropertiesPanel::OnIntersection ), NULL, this );
  ...
  m_Union->Connect( m_Union->GetId(), wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( SelectionPropertiesPanel::OnUnion ), NULL, this );
  ...
  m_ExpandAll->Connect( m_ExpandAll->GetId(), wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( SelectionPropertiesPanel::OnExpandAll ), NULL, this );
  ...
  m_CollapseAll->Connect( m_CollapseAll->GetId(), wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( SelectionPropertiesPanel::OnCollapseAll ), NULL, this );
...
void SelectionPropertiesPanel::OnIntersection(wxCommandEvent& event)
{
  m_PropertyManager->SetProperties( PropertySettings::Intersection );
}

void SelectionPropertiesPanel::OnUnion(wxCommandEvent& event)
{
  m_PropertyManager->SetProperties( PropertySettings::Union );
}

void SelectionPropertiesPanel::OnExpandAll(wxCommandEvent& event)
{
