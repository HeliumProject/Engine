...
/////////////////////////////////////////////////////////////////////////////
bool Application::InitializeExceptionDB()
{
  g_DBHandle = new SQL::MySQL( "Application-ExceptionDB" );
  return true;
}

/////////////////////////////////////////////////////////////////////////////
void Application::CleanupExceptionDB()
{
  delete g_DBHandle;
  g_DBHandle = NULL;
}
...
/////////////////////////////////////////////////////////////////////////////
void Application::UpdateExceptionDB( const ExceptionReport& report )
{
