...
{
  comp.GetComposite().m_UIName = TXT( "Expensive Map" );
  comp.GetComposite().SetProperty( AssetProperties::ShortDescription, TXT( "Settings for Gloss, Parallax, and Incandescent Maps." ) );
  comp.GetComposite().SetProperty( AssetProperties::LongDescription, TXT( "As the name indicates, this map contains more data and is more expensive in terms of calculations and memory usage." ) );
  comp.GetComposite().SetProperty( AssetProperties::SmallIcon, TXT( "attribute_expensivemap_16.png" ) );
  ...
  fieldGlossScale->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=0.0; max=8.0} value{}].]" ) );
  ...
  fieldGlossDirty->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=0.0; max=1.0} value{}].]" ) );
  ...
  fieldCubeBias->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=-4.0; max=0.0} value{}].]" ) );
  ...
  fieldRealTimeSpecPower->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=1.0; max=127.0} value{}].]" ) );
  ...
  fieldRealTimeSpecIntensity->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=0.0; max=4.0} value{}].]" ) );
  ...
  fieldRimStrength->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=0.0; max=64.0} value{}].]" ) );
  ...
  fieldRimTightness->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=0.0; max=16.0} value{}].]" ) );
  ...
  fieldParallaxScale->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=0.0; max=0.15} value{}].]" ) );
  ...
  fieldParallaxBias->SetProperty( TXT( "UIScript" ), TXT( "UI[.[slider{min=0.0; max=1.0} value{}].]" ) );
...
bool StandardExpensiveMapComponent::ProcessComponent(Reflect::ElementPtr element, const tstring& fieldName)
{
  if ( fieldName == TXT( "m_CubeTint" ) )
  {
