...
bool Processor::Initialize( tstring& error )
{
	bool result = true;
	...
	result &= m_OptionsMap.AddOption( new FlagOption( &m_HelpFlag, TXT( "help" ), TXT( "print program usage" ) ), error );
...
const Command* Processor::GetCommand( const tstring& token )
{
