...
Core::EntityAssetSet* Entity::GetClassSet()
{
    return m_ClassSet;
}

const Core::EntityAssetSet* Entity::GetClassSet() const
{
    return m_ClassSet;
}

void Entity::SetClassSet(Core::EntityAssetSet* classSet)
{
    m_ClassSet = classSet;
}
...
void Entity::DrawBounds( IDirect3DDevice9* device, DrawArgs* args, const SceneNode* object )
{
    ...
    const Core::EntityAssetSet* classSet = entity->GetClassSet();
