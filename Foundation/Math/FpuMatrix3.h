...
namespace Helium
{
    ...
    class HELIUM_FOUNDATION_API Matrix3
    {
    public:
        union
        {
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const Matrix3& vector);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, Matrix3& vector);
        friend class HELIUM_FOUNDATION_API Matrix4;
    };
