...
project( prefix .. "ApplicationUI" )

	Helium.DoModuleProjectSettings( ".", "HELIUM", "ApplicationUI", "APPLICATION_UI" )
	...
	if os.get() == "windows" then
		pchheader( "ApplicationUIPch.h" )
		pchsource( "ApplicationUI/ApplicationUIPch.cpp" )
	else
		includedirs
		{
			"ApplicationUI",
