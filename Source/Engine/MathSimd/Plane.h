...
namespace Helium
{
	namespace Simd
	{
		...
		HELIUM_ALIGN_PRE( 16 ) class HELIUM_MATH_SIMD_API Plane
		{
		public:
			...
			inline bool CalculateLineIntersect(const Simd::Vector3 &linePoint, const Simd::Vector3 &lineDirectionNormalized, Simd::Vector3 &intersectPoint) const;
...
#include "MathSimd/Plane.inl"

#if HELIUM_SIMD_SSE
#include "MathSimd/PlaneSse.inl"
#endif
