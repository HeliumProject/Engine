...
public:
    ...
    virtual bool OnVisit(const wxTreeItemId& item)
    {
        ...
        if ( UIToolKit::IsItemSelected(GetHwndOf(tree), HITEM(item)) )
        {
...
void TreeCtrl::UnselectAll()
{
    ...
    {
        bool sendChangedEvent = UIToolKit::TryUnselectAll( this );
    ...
    else if ( (nMsg >= WM_MOUSEFIRST) && (nMsg <= WM_MOUSELAST) )
    {
        ...
        switch ( nMsg )
        {
            case WM_RBUTTONDOWN:
                ...
                if ( !htItem || !UIToolKit::IsItemSelected(GetHwnd(), htItem) )
                {
                    UnselectAll();
                }
                ...
                // newly selected item
                if ( !UIToolKit::IsItemSelected( GetHwnd(), htItem ) )
                {
                    if ( isMultiple )
                    {
                        if ( htItem )
                ...
                if ( isMultiple )
                {
                    ...
                    if ( htItem && tvht.flags & TVHT_ONITEM ) 
                    {
                        ...
                        if ( wParam & MK_SHIFT )
                        {
                            ...
                            {
                                // Select range
                                UIToolKit::SelectRange( GetHwnd(), this, HITEM( m_htSelStart ), htItem );
                            }
                        }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    UIToolKit::TryUnselectAll( this ); // Does not fire the "changed" event
