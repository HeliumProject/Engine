...
{
    int32_t bestIndex = -1;
    float32_t distance = Math::BigFloat;
    float32_t bestDistance = Math::BigFloat;
    Math::Vector3 point;
...
int32_t Curve::ClosestPoint(Math::Vector3& pos)
{
    int bestIndex = -1;
    float distance = 0.0f;
    float bestDistance = 0.0f;
...
float32_t Curve::DistanceSqrToCurve( const Math::Vector3& point ) const
{
...
float32_t Curve::DistanceToCurve( const Math::Vector3& point ) const
{
