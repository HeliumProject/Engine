...
namespace Maya
{
  ...
  MAYA_API void     S_MObjectToObjectArray( const S_MObject &nodes, MObjectArray &array );

  MAYA_API MStatus  findNodesOfType( S_MObject &nodes,    const MTypeId &typeId, const MFn::Type FnType = MFn::kInvalid, MObject& pathRoot = MObject::kNullObj );
  ...
  MAYA_API MStatus  findNodesOfType( S_MObject &nodes,    const MString &typeStr, bool isDagNode = true );
  MAYA_API MStatus  findNodesOfType( MObjectArray &array, const MString &typeStr, bool isDagNode = true );

  MAYA_API MStatus  findNodesOfType( S_MObject &nodes,     const MFn::Type FnType, MObject& pathRoot = MObject::kNullObj );
  ...
  MAYA_API void     appendObjectArray( S_MObject &receiver, const MObjectArray & source );
