...
namespace Reflect
{
    ...
    class REFLECT_API ExceptionInfo
    {
    public:
        const Archive& m_Archive;
    ...
    class REFLECT_API StatusHandler
    {
    public:
    ...
    class REFLECT_API PrintStatus : public StatusHandler
    {
    public:
        bool m_Start;
        u64  m_Timer;
