...
namespace Helium
{
    namespace Reflect
    {
        ...
        public:
            ...
            static void Visit (Object* element, Visitor& visitor);
            ...
            static void Copy( const Object* src, Object* dest );
