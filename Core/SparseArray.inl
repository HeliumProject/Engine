...
namespace Lunar
{
    ...
    template< typename T >
    ConstSparseArrayIterator< T >::ConstSparseArrayIterator()
    {
    }
    ...
    template< typename T >
    ConstSparseArrayIterator< T >::operator bool() const
    {
    ...
    ///
    /// Note that an iterator could be referencing an unused array slot.  You should always check whether the iterator
    /// is referencing a used array slot first using the "bool" operator overload.
    ///
    ...
    template< typename T >
    ConstSparseArrayIterator< T >& ConstSparseArrayIterator< T >::operator++()
    {
        ++m_pElement;
    ...
    template< typename T >
    ConstSparseArrayIterator< T > ConstSparseArrayIterator< T >::operator++( int )
    {
    ...
    /// @return  Reference to this iterator.
    template< typename T >
    ConstSparseArrayIterator< T >& ConstSparseArrayIterator< T >::operator+=( ptrdiff_t offset )
    {
        m_pElement += offset;
    ...
    template< typename T >
    ConstSparseArrayIterator< T > ConstSparseArrayIterator< T >::operator+( ptrdiff_t offset ) const
    {
        ConstSparseArrayIterator result = *this;
        result += offset;
    ...
    template< typename T >
    ptrdiff_t ConstSparseArrayIterator< T >::operator-( const ConstSparseArrayIterator& rOther ) const
    {
    ...
    template< typename T >
    bool ConstSparseArrayIterator< T >::operator==( const ConstSparseArrayIterator& rOther ) const
    {
        return( m_pElement == rOther.m_pElement );
    }
    ...
    /// Creates an uninitialized iterator.  Using this is not safe until it is initialized.
    template< typename T >
    SparseArrayIterator< T >::SparseArrayIterator()
    {
    }
    ...
    /// @param[in] usedElementMask   Bit mask for the in-use bit for the current array element.
    template< typename T >
    SparseArrayIterator< T >::SparseArrayIterator( T* pElement, uint32_t* pUsedElementBits, uint32_t usedElementMask )
    ...
    /// @return  Reference to this iterator.
    template< typename T >
    SparseArrayIterator< T >& SparseArrayIterator< T >::operator++()
    {
    ...
    /// @return  Copy of this iterator prior to incrementing.
    template< typename T >
    SparseArrayIterator< T > SparseArrayIterator< T >::operator++( int )
    {
    ...
    /// @return  Reference to this iterator.
    template< typename T >
    SparseArrayIterator< T >& SparseArrayIterator< T >::operator+=( ptrdiff_t offset )
    {
    ...
    /// @return  Copy of this iterator, increased by the specified amount.
    template< typename T >
    SparseArrayIterator< T > SparseArrayIterator< T >::operator+( ptrdiff_t offset ) const
    {
        SparseArrayIterator result = *this;
        result += offset;
    ...
    SparseArray< T, Allocator >::SparseArray()
        : m_pBuffer( NULL )
    ...
    template< typename T, typename Allocator >
    SparseArray< T, Allocator >::SparseArray( const T* pSource, size_t size )
        : m_pBuffer( NULL )
        , m_pUsedElements( NULL )
        , m_size( size )
        , m_usedSize( size )
    ...
    /// for this copy).  Holes will be compacted as well.
    ///
    /// @param[in] rSource  Array from which to copy.
    template< typename T, typename Allocator >
    template< typename OtherAllocator >
    SparseArray< T, Allocator >::SparseArray( const SparseArray< T, OtherAllocator >& rSource )
        : m_pBuffer( NULL )
        , m_pUsedElements( NULL )
        , m_size( 0 )
        , m_usedSize( 0 )
    ...
    template< typename T, typename Allocator >
    size_t SparseArray< T, Allocator >::GetSize() const
    {
        return m_size;
    }
    ...
    template< typename T, typename Allocator >
    size_t SparseArray< T, Allocator >::GetUsedSize() const
    {
        return m_usedSize;
    }
    ...
    template< typename T, typename Allocator >
    size_t SparseArray< T, Allocator >::GetCapacity() const
    {
        return m_capacity;
    }
    ...
    /// @see GetCapacity()
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::Reserve( size_t capacity )
    {
    ...
    /// @see GetCapacity()
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::Trim()
    {
    ...
    /// @return  Array buffer.
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::GetData()
    {
        return m_pBuffer;
    }
    ...
    /// @return  Array buffer.
    template< typename T, typename Allocator >
    const T* SparseArray< T, Allocator >::GetData() const
    {
        return m_pBuffer;
    }
    ...
    template< typename T, typename Allocator >
    const uint32_t* SparseArray< T, Allocator >::GetUsedElements() const
    {
    ...
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::Clear()
    {
        InPlaceDestroy( m_pBuffer, m_size, m_pUsedElements );
        m_allocator.Free( m_pBuffer );
        m_pBuffer = NULL;
    ...
    /// @see End()
    template< typename T, typename Allocator >
    typename SparseArray< T, Allocator >::Iterator SparseArray< T, Allocator >::Begin()
    {
    ...
    /// @see End()
    template< typename T, typename Allocator >
    typename SparseArray< T, Allocator >::ConstIterator SparseArray< T, Allocator >::Begin() const
    {
    ...
    /// @see Begin()
    template< typename T, typename Allocator >
    typename SparseArray< T, Allocator >::Iterator SparseArray< T, Allocator >::End()
    {
        size_t size = m_size;
    ...
    /// @see Begin()
    template< typename T, typename Allocator >
    typename SparseArray< T, Allocator >::ConstIterator SparseArray< T, Allocator >::End() const
    {
        size_t size = m_size;
    ...
    ///
    /// This will remove the element at the specified index, leaving an empty slot in its place.  Other array elements
    ...
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::Swap( SparseArray& rArray )
    {
        T* pBuffer = m_pBuffer;
...
#undef L_IMPLEMENT_SPARSEARRAY_NEW_Z
    ...
    template< typename T, typename Allocator >
    SparseArray< T, Allocator >& SparseArray< T, Allocator >::operator=( const SparseArray& rSource )
    {
    ...
    template< typename T, typename Allocator >
    template< typename OtherAllocator >
    SparseArray< T, Allocator >& SparseArray< T, Allocator >::operator=(
    ...
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::Grow( size_t capacity )
    {
        if( capacity > m_capacity )
        {
    ...
    template< typename T, typename Allocator >
    size_t SparseArray< T, Allocator >::AllocateSlot()
    {
        size_t size = m_size;
    ...
    /// that only takes the same exact SparseArray type (non-templated) as well.
    ///
    /// @param[in] rSource  Array from which to copy.
    ///
    /// @return  Reference to this array.
    template< typename T, typename Allocator >
    template< typename OtherAllocator >
    SparseArray< T, Allocator >& SparseArray< T, Allocator >::Assign( const SparseArray< T, OtherAllocator >& rSource )
    {
        if( this != &rSource )
        {
            Clear();
    ...
    /// @see Reallocate()
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::Allocate( size_t count )
    {
    ...
    /// @see Reallocate()
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::Allocate( size_t count, const boost::true_type& /*rNeedsAlignment*/ )
    {
    ...
    /// @see Reallocate()
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::Allocate( size_t count, const boost::false_type& /*rNeedsAlignment*/ )
    {
    ...
    /// @see Allocate()
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::Reallocate( T* pMemory, size_t count )
    {
        return Reallocate(
            pMemory,
            count,
    ...
    /// @see Reallocate()
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::Reallocate( T* pMemory, size_t count, const boost::true_type& /*rNeedsAlignment*/ )
    {
    ...
    /// @see Reallocate()
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::Reallocate( T* pMemory, size_t count, const boost::false_type& /*rNeedsAlignment*/ )
    {
    ...
    template< typename T, typename Allocator >
    T* SparseArray< T, Allocator >::ResizeBuffer(
        T* pMemory,
        size_t elementRange,
    ...
    /// @param[in] pUsedElements  Bit array specifying which elements are in use.
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::InPlaceDestroy( T* pMemory, size_t range, const uint32_t* pUsedElements )
    {
    ...
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::InPlaceDestroy(
        T* /*pMemory*/,
        size_t /*range*/,
        const uint32_t* /*pUsedElements*/,
    ...
    /// Construct copies of used elements from the source sparse array in the uninitialized destination buffer, matching
    /// up the used element slots.
    ///
    ...
    template< typename T, typename Allocator >
    void SparseArray< T, Allocator >::UninitializedCopy(
        T* pDest,
        const T* pSource,
        size_t range,
        const uint32_t* pUsedElements )
