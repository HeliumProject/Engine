...
Helium::Simd::Vector4 Helium::Simd::Vector4::Add( const Vector4& rVector ) const
{
    Vector4 result;
...
Helium::Simd::Vector4 Helium::Simd::Vector4::Subtract( const Vector4& rVector ) const
{
    Vector4 result;
...
Helium::Simd::Vector4 Helium::Simd::Vector4::Multiply( const Vector4& rVector ) const
{
    Vector4 result;
...
Helium::Simd::Vector4 Helium::Simd::Vector4::Divide( const Vector4& rVector ) const
{
    Vector4 result;
...
///
/// @see Scale()
Helium::Simd::Vector4 Helium::Simd::Vector4::GetScaled( float32_t scale ) const
{
    Vector4 result;
...
///
/// @see GetScaled()
void Helium::Simd::Vector4::Scale( float32_t scale )
{
...
float32_t Helium::Simd::Vector4::GetMagnitudeSquared() const
{
    return Dot( *this );
}
...
///
/// @see Normalize()
Helium::Simd::Vector4 Helium::Simd::Vector4::GetNormalized( float32_t epsilon ) const
{
    Vector4 result = *this;
...
///
/// @see Negate()
Helium::Simd::Vector4 Helium::Simd::Vector4::GetNegated() const
{
    Vector4 result;
    GetNegated( result );
...
///
/// @see GetNegated()
void Helium::Simd::Vector4::Negate()
{
    GetNegated( *this );
}
...
///
/// @return  Copy of this vector with the sign of each component flipped.
Helium::Simd::Vector4 Helium::Simd::Vector4::operator-() const
{
    return GetNegated();
}
...
///
/// @return  Vector containing the sums of each component.
Helium::Simd::Vector4 Helium::Simd::Vector4::operator+( const Vector4& rVector ) const
{
    return Add( rVector );
}
...
Helium::Simd::Vector4& Helium::Simd::Vector4::operator+=( const Vector4& rVector )
{
    AddSet( *this, rVector );
...
///
/// @return  Copy of this vector scaled by the specified amount.
Helium::Simd::Vector4 Helium::Simd::Vector4::operator*( float32_t scale ) const
{
...
///
/// @return  Reference to this vector.
Helium::Simd::Vector4& Helium::Simd::Vector4::operator*=( float32_t scale )
{
    Scale( scale );
...
bool Helium::Simd::Vector4::operator==( const Vector4& rVector ) const
{
...
Helium::Simd::Vector4 Helium::Simd::operator*( float32_t scale, const Vector4& rVector )
{
