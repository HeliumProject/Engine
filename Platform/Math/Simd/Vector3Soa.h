...
namespace Helium
{
    namespace Simd
    {
        ...
        HELIUM_SIMD_ALIGN_PRE class PLATFORM_API Vector3Soa
        {
        public:
            /// X components.
            Register m_x;
...
#include "Platform/Math/Simd/Vector3Soa.inl"

#if HELIUM_SIMD_LRBNI
#include "Platform/Math/Simd/Lrbni/Vector3Soa.inl"
#elif HELIUM_SIMD_SSE
#include "Platform/Math/Simd/Sse/Vector3Soa.inl"
#endif
