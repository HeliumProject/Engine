...
///////////////////////////////////////////////////////////////////////////////
NavigationPanel::NavigationPanel( VaultFrame* browserFrame, SearchHistory* history )
...
, m_IgnoreNavBarTextChanged( false )
{
  ...
  m_SearchHistory->AddResetListener( Editor::SearchHistoryChangedSignature::Delegate( this, &NavigationPanel::OnSearchHistoryChanged ) );
  m_SearchHistory->AddHistoryChangedListener( Editor::SearchHistoryChangedSignature::Delegate( this, &NavigationPanel::OnSearchHistoryChanged ) );
  m_SearchHistory->AddMRUQueriesChangedListener( Editor::MRUQueriesChangedSignature::Delegate( this, &NavigationPanel::OnMRUQueriesChanged ) );
}
...
NavigationPanel::~NavigationPanel()
{
  ...
  m_SearchHistory->RemoveResetListener( Editor::SearchHistoryChangedSignature::Delegate( this, &NavigationPanel::OnSearchHistoryChanged ) );
  m_SearchHistory->RemoveHistoryChangedListener( Editor::SearchHistoryChangedSignature::Delegate( this, &NavigationPanel::OnSearchHistoryChanged ) );
  m_SearchHistory->RemoveMRUQueriesChangedListener( Editor::MRUQueriesChangedSignature::Delegate( this, &NavigationPanel::OnMRUQueriesChanged ) );
...
void NavigationPanel::OnUpFolderButtonClick( wxCommandEvent& event )
{
  if ( m_NavBarIsFolder )
  {
      Helium::Path folder( GetNavBarValue().c_str() );
...
{ 
  ...
  //m_VaultFrame->Search( GetNavBarValue().c_str() );
...
void NavigationPanel::OnNavBarTextEnter( wxCommandEvent& event )
{
  ...
  m_VaultFrame->Search( (const wxChar*)GetNavBarValue().c_str() ); 
}
...
///////////////////////////////////////////////////////////////////////////////
void NavigationPanel::OnSearchHistoryChanged( const Editor::SearchHistoryChangeArgs& args )
{ 
  UpdateHistoryMenus();
}

///////////////////////////////////////////////////////////////////////////////
void NavigationPanel::OnMRUQueriesChanged( const Editor::MRUQueriesChangedArgs& args )
{
