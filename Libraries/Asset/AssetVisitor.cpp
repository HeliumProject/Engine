...
/////////////////////////////////////////////////////////////////////////////
void AssetVisitor::HandleFileID( Reflect::Element* element, const Reflect::Field* field, tuid id )
{
  if ( ( id == TUID::Null )
...
void AssetVisitor::AddDependency( AssetFile* assetFile )
{
  ...
  if ( parentAssetFile )
  {
    parentAssetFile->AddDependencyID( assetFile->GetFileID() );
  }
}

/////////////////////////////////////////////////////////////////////////////
void AssetVisitor::PushID( tuid id )
{
  m_VisitedIDStack.push_back( id );
}

/////////////////////////////////////////////////////////////////////////////
void AssetVisitor::PopID()
{
  if ( m_VisitedIDStack.empty() )
  {
    NOC_BREAK();
