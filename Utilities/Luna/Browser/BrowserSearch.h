...
namespace Luna
{
    ...
    private:
        ...
        Nocturnal::S_Path       m_FoundFiles;        // The *complete* list of found files from this section
    ...
    private:
        ...
        //
        void OnBeginSearchThread( const Luna::DummyWindowArgs& args );
        void OnResultsAvailable( const Luna::DummyWindowArgs& args );
        void OnEndSearchThread( const Luna::DummyWindowArgs& args );
        ...
        u32 FoundAssetFiles( const Nocturnal::S_Path& assetFileRefs, i32 searchID );
