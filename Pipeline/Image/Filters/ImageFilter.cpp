...
ImageFilter::ImageFilter(const tchar_t* inputfile, const tchar_t* outputfile, unsigned int xres, unsigned int yres, unsigned int width, unsigned int flags)
: output(NULL)
, filterWidth(width)
, opFlags(flags)
...
BoxImageFilter::BoxImageFilter(const tchar_t* inputfile, const tchar_t* outputfile, unsigned int xres, unsigned int yres, unsigned int width, unsigned int flags)
