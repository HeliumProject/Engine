...
namespace Lunar
{
    ...
    Vector2 Vector2::Add( const Vector2& rVector ) const
    {
    ...
    Vector2 Vector2::Subtract( const Vector2& rVector ) const
    {
        return Vector2( m_vector[ 0 ] - rVector.m_vector[ 0 ], m_vector[ 1 ] - rVector.m_vector[ 1 ] );
    }
    ...
    Vector2 Vector2::Multiply( const Vector2& rVector ) const
    {
        return Vector2( m_vector[ 0 ] * rVector.m_vector[ 0 ], m_vector[ 1 ] * rVector.m_vector[ 1 ] );
    }
    ...
    Vector2 Vector2::Divide( const Vector2& rVector ) const
    {
        return Vector2( m_vector[ 0 ] / rVector.m_vector[ 0 ], m_vector[ 1 ] / rVector.m_vector[ 1 ] );
    }
    ...
    void Vector2::AddSet( const Vector2& rVector0, const Vector2& rVector1 )
    {
    ...
    /// @param[in] rVector0  First vector.
    /// @param[in] rVector1  Second vector.
    void Vector2::SubtractSet( const Vector2& rVector0, const Vector2& rVector1 )
    {
        m_vector[ 0 ] = rVector0.m_vector[ 0 ] - rVector1.m_vector[ 0 ];
        m_vector[ 1 ] = rVector0.m_vector[ 1 ] - rVector1.m_vector[ 1 ];
    }
    ...
    /// @param[in] rVector0  First vector.
    /// @param[in] rVector1  Second vector.
    void Vector2::MultiplySet( const Vector2& rVector0, const Vector2& rVector1 )
    {
        m_vector[ 0 ] = rVector0.m_vector[ 0 ] * rVector1.m_vector[ 0 ];
        m_vector[ 1 ] = rVector0.m_vector[ 1 ] * rVector1.m_vector[ 1 ];
    }
    ...
    /// @param[in] rVector0  First vector.
    /// @param[in] rVector1  Second vector.
    void Vector2::DivideSet( const Vector2& rVector0, const Vector2& rVector1 )
    {
        m_vector[ 0 ] = rVector0.m_vector[ 0 ] / rVector1.m_vector[ 0 ];
        m_vector[ 1 ] = rVector0.m_vector[ 1 ] / rVector1.m_vector[ 1 ];
    }
    ...
    void Vector2::MultiplyAddSet( const Vector2& rVectorMul0, const Vector2& rVectorMul1, const Vector2& rVectorAdd )
    {
    ...
    ///
    /// @see Scale()
    Vector2 Vector2::GetScaled( float32_t scale ) const
    {
    ...
    ///
    /// @see GetScaled()
    void Vector2::Scale( float32_t scale )
    {
        m_vector[ 0 ] *= scale;
        m_vector[ 1 ] *= scale;
    }
    ...
    ///
    /// @return  Dot product.
    float32_t Vector2::Dot( const Vector2& rVector ) const
    {
    ...
    float32_t Vector2::Cross( const Vector2& rVector ) const
    {
    ...
    float32_t Vector2::GetMagnitude() const
    {
    ...
    float32_t Vector2::GetMagnitudeSquared() const
    {
    ...
    ///
    /// @see Normalize()
    Vector2 Vector2::GetNormalized( float32_t epsilon ) const
    {
        Vector2 result = *this;
    ...
    ///
    /// @see GetNormalized()
    void Vector2::Normalize( float32_t epsilon )
    {
    ...
    ///
    /// @see Negate()
    void Vector2::GetNegated( Vector2& rResult ) const
    {
    ...
    bool Vector2::Equals( const Vector2& rVector, float32_t epsilon ) const
    {
    ...
    Vector2& Vector2::operator+=( const Vector2& rVector )
    {
        AddSet( *this, rVector );
    ...
    ///
    /// @return  Copy of this vector scaled by the specified amount.
    Vector2 Vector2::operator*( float32_t scale ) const
    {
    ...
    ///
    /// @return  Reference to this vector.
    Vector2& Vector2::operator*=( float32_t scale )
    {
        Scale( scale );
    ...
    bool Vector2::operator==( const Vector2& rVector ) const
    {
