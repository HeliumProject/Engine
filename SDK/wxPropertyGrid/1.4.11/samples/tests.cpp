...
void FormMain::AddTestProperties( wxPropertyGridPage* pg )
{
    ...
    prop = pg->Append( new wxMyColourProperty(wxT("CustomColourProperty1")) );
    pg->SetPropertyAttribute(prop, wxPG_COLOUR_ALLOW_CUSTOM, false);
                           ...
                           wxPGProperty* p2)
{
    ...
    return p2->GetLabel().compare( p1->GetBaseName() );
}
...
#define FLAG_TEST_SET2 (wxSTAY_ON_TOP|wxCAPTION|wxICONIZE|wxSYSTEM_MENU)
        ...
        // Original string value: "Lamborghini Diablo SV; [300; 3.9; 8.6]; 300000; Not Convertible"
...

    {
        ...
        pgman->GetGrid()->Sort(wxT("Environment"));
