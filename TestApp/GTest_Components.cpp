...
//     EXPECT_TRUE(test_host.FindOneComponentThatImplements<TestComponentThree>() == 0);
    ...
    // Attach components
    Helium::Components::Component *c1 = Helium::Components::Allocate<TestComponentOne>(test_host.m_Components);
    Helium::Components::Component *c2 = Helium::Components::Allocate<TestComponentTwo>(test_host.m_Components);
    Helium::Components::Component *c3 = Helium::Components::Allocate<TestComponentThree>(test_host.m_Components);
...
//     EXPECT_TRUE(component_list_3.size() == 1);
    ...
    Helium::Components::Free(test_host.m_Components, *c1);
...
TEST_F(Components, HostAttachDetachIterate)
{
    ...
    {
        Helium::Components::Component *one = Helium::Components::Allocate<TestComponentOne>(test_host.m_Components);
        Helium::Components::Component *two = Helium::Components::Allocate<TestComponentTwo>(test_host.m_Components);
        Helium::Components::Component *three = Helium::Components::Allocate<TestComponentThree>(test_host.m_Components);
