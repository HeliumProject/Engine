...
namespace UIToolKit
{
  ...
  //
  template<class T>
  class UITOOLKIT_API MRU : public Nocturnal::RefCountBase< MRU<T> >
  {
  public:
  ...
  typedef UITOOLKIT_API MRU< std::string > ManagedStringSet;
  typedef UITOOLKIT_API Nocturnal::SmartPtr< ManagedStringSet > ManagedStringSetPtr;
