...
namespace Helium
{
    namespace Editor {
        ...
        public:
            ...
            static void link(const litesql::Database& db, const Helium::Editor::TrackedFile& o0, const Helium::Editor::TrackedProperty& o1, tstring mValue= TXT( "" ));
            static void unlink(const litesql::Database& db, const Helium::Editor::TrackedFile& o0, const Helium::Editor::TrackedProperty& o1, tstring mValue);
        ...
        public:
            ...
            static void link(const litesql::Database& db, const Helium::Editor::TrackedFile& o0, const Helium::Editor::TrackedFile& o1);
            static void unlink(const litesql::Database& db, const Helium::Editor::TrackedFile& o0, const Helium::Editor::TrackedFile& o1);
            static void del(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr());
            static litesql::DataSource<FileReferences::Row> getRows(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr());
            static litesql::DataSource<Helium::Editor::TrackedFile> getTrackedFile1(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr(), const litesql::Expr& srcExpr=litesql::Expr());
            static litesql::DataSource<Helium::Editor::TrackedFile> getTrackedFile2(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr(), const litesql::Expr& srcExpr=litesql::Expr());
        };
        ...
        public:
            ...
            static const litesql::FieldType MToolsVersion;
            litesql::Field<int> mToolsVersion;
            static const litesql::FieldType MBroken;
            litesql::Field<int> mBroken;
        protected:
            void defaults();
        public:
