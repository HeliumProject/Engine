...
AssetCacheDB::AssetCacheDB(tstring backendType, tstring connInfo)
     : litesql::Database(backendType, connInfo) {
    initialize();
}
std::vector<litesql::Database::SchemaItem> AssetCacheDB::getSchema() const {
