...
namespace Helium
{
    namespace Editor
    {
        ...
        typedef Helium::Signature< void, const CollectionManagerArgs& > CollectionManagerSignature;
        ...
        private:
            ...
            Helium::Insert<M_AssetCollections>::Result AddCollectionToMap( AssetCollection* collection );
        ...
        typedef Helium::SmartPtr< CollectionManager > CollectionManagerPtr;
    }
}