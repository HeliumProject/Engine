...
{
    class PIPELINE_API BuilderOptions : public Reflect::Element
    {
    public:
        bool m_SkipNested;
    ...
    class PIPELINE_API ZoneBuilderOptions : public BuilderOptions
    {
    public:
    ...
    class PIPELINE_API LevelBuilderOptions : public BuilderOptions
    {
    public:
        bool        m_NoMobys;
        bool        m_NoConduit;
    ...
    class PIPELINE_API RegionBuilderOptions : public BuilderOptions
    {
    public:
    ...
    class PIPELINE_API ShrubBuilderOptions : public BuilderOptions
    {
    public:
    ...
    class PIPELINE_API TieBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API UfragBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API ShaderBuilderOptions : public BuilderOptions
    {
    public:
    ...
    class PIPELINE_API TexturePackBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API FoliageBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API FontBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API MobyBuilderOptions : public BuilderOptions
    {
    public:
        bool        m_Conduit;
        bool        m_AnimDump;
    ...
    class PIPELINE_API MovieBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API AnimationBuilderOptions : public BuilderOptions
    {
    public:
        bool m_DumpAnims;
        bool m_DumpJoints;
    ...
    class PIPELINE_API SkyBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API CinematicBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API CubeMapBuilderOptions : public BuilderOptions
    {
    ...
    class PIPELINE_API SymbolEnumAutoFixupOptions : public BuilderOptions
    {
    public:
