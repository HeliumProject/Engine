...
namespace Helium
{
    namespace Editor
    {
        class HierarchyPanel : public HierarchyPanelGenerated
        {
        public:
            HierarchyPanel( Editor::SceneManager* manager, TreeMonitor* treeMonitor, wxWindow* parent = NULL, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,300 ), long style = wxTAB_TRAVERSAL );
