...
namespace Helium
{
    namespace Simd
    {
        ...
        /// SIMD support.
        HELIUM_ALIGN_PRE( 16 ) class PLATFORM_API Vector3
        {
        public:
...
#include "Platform/Math/Simd/Vector3.inl"

#if HELIUM_SIMD_LRBNI
#include "Platform/Math/Simd/Lrbni/Vector3.inl"
#elif HELIUM_SIMD_SSE
#include "Platform/Math/Simd/Sse/Vector3.inl"
#endif
