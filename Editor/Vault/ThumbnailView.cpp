...
#endif
{
	// TODO: reimplement icons as resources
#ifdef VIEWPORT_REFACTOR
...
void ThumbnailView::CreateResources()
{
	...
	// TODO: redo the below as resources
...
void ThumbnailView::Pick( wxPoint mousePos1, wxPoint mousePos2, OS_ThumbnailTiles& hits )
{
	...
	// TODO: ThumbnailView::Pick - Support rubber-band selection, actually use mousePos2, return more than 1 hit in that case
...
void ThumbnailView::DrawTile( IDirect3DDevice9* device, ThumbnailTile* tile, bool overlayOnly )
{
	...
	if ( m_ViewFrustum.IntersectsBox( box ) )
	{
		...
		if ( !label.empty() )
		{
			...
			// TODO: ThumbnailView::DrawTile - Create a sprite object to improve efficiency (see DirectX docs)
			RECT calcRect( rect );
