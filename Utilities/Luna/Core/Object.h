...
namespace Luna
{
  ...
  typedef Nocturnal::Signature< void, const ObjectChangeArgs& > ObjectChangeSignature;
  ...
  public:
    LUNA_DECLARE_TYPE( Object, Reflect::Object );
