...
Vector4 Helium::Simd::Vector3ToVector4( const Vector3& rVector )
{
    Vector4 result;
...
Vector4 Helium::Simd::PointToVector4( const Vector3& rVector )
{
...
Vector4 Helium::Simd::RayToVector4( const Vector3& rVector )
{
...
Vector3 Helium::Simd::Vector4ToVector3( const Vector4& rVector )
{
    Vector3 result;
    MemoryCopy( &result, &rVector, sizeof( result ) );
