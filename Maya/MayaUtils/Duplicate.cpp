...
//
// igDuplicate.cpp:
// Insomniac's common functions for duplicating and instancing within maya
//
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
namespace Maya
{
  ...
  bool duplicate( const MDagPath & sourcePath,
    ...
    bool       duplicateUpstreamGraph )
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - top IGDUPLICATE::duplicate " ));
  ...
  */
  ...
  bool DependencyDuplicator::copyAttributes( MFnDependencyNode & sourceNodeFn,
    ...
    bool                copyAll )
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - top DependencyDuplicator::copyAttributes " ));
    MStatus stat;
    bool    success = false;
    // look for attributes of the source
    unsigned int attributeCount = sourceNodeFn.attributeCount( &stat );
    if (stat==MS::kSuccess)
    {
      ...
      for (unsigned int i=0; success && i<attributeCount; i++)
      {
        MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - copyAttribute " ));
                ...
                else
                {
                  ...
                  if (stat==MS::kSuccess)
                  {
                    ...
                    else
                    {
                      ...
                      if (stat==MS::kSuccess)
                      {
                        MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - copyPlugValue " ));
  ...
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - DagDuplicator::dagDuplicate " ));
    MStatus    stat;
    bool       success = false;
  ...
  bool DagDuplicator::dagDuplicate_instance( MFnDagNode & sourceNodeFn,
    ...
    MFnDagNode & destinNodeFn )
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - DagDuplicator::dagDuplicate_instance " ));
    MStatus stat;
    bool    success = false;
  ...
  bool DagDuplicator::dagDuplicate_copy( MFnDagNode & sourceNodeFn,
    ...
    MFnDagNode & destinNodeFn )
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - DagDuplicator::dagDuplicate_copy " ));
    MStatus    stat;
    ...
    if ( dagNodeCopy(sourceNodeFn, destinParentFn, destinNodeFn) )
    {
      ...
      success = (stat==MS::kSuccess);
      {
        MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - DagDuplicator::dagDuplicate_copy children " ));
  ...
  bool DagDuplicator::dagNodeCopy( MFnDagNode & sourceNodeFn,
    ...
    MFnDagNode & destinNodeFn )
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - DagDuplicator::dagNodeCopy " ));
    MStatus      stat;
    bool         success = false;
          ...
          if (stat==MS::kSuccess)
          {
            ...
            if (destinObj==MObject::kNullObj)
            {
              ...
              if (stat==MS::kSuccess)
              {
                ...
                if (sourceType==IGL_REFERENCETRANSFORM_ID)
                {
                  // objects of type ReferenceTransform become Transform objects
                  MFnTransform transformFn;
                  destinObj = transformFn.create( destinParentObj );
                  // the object type changed so don't copy attributes
                  copyNoAttributes = true;
                }
                else
                {
  ...
  MObject DagDuplicator::copyNode( const MDagPath & sourcePath,
    MObject    destinParentObj )
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - DagDuplicator::copyNode " ));
  ...
  inline static bool copyScalarPlugValue( MPlug & sourcePlug,
    MPlug & destinPlug )
  {
    MAYAUTILS_SCOPE_TIMER(( __FUNCTION__ " - copyScalarPlugValue " ));
