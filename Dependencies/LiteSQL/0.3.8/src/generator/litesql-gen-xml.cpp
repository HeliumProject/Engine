...
bool generate(xml::Field* const field, LITESQL_oStream& os,size_t indent)
{
...
void generate(xml::Method* const pMethod,LITESQL_oStream& os,size_t indent)
{
    LITESQL_String indent_string(indent,' ');
...
bool XmlGenerator::generate(xml::Object* const object,LITESQL_oStream& os,size_t indent)
{
    LITESQL_String indent_string(indent,' ');
    ...
    for (std::vector<xml::Field*>::const_iterator field_it = object->fields.begin();
    ...
    for (std::vector<xml::Method*>::const_iterator method_it = object->methods.begin();
