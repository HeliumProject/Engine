...
#ifndef _WX_TREEWNDCTRL_H_
#define _WX_TREEWNDCTRL_H_
...
enum wxTreeWndCtrlDashMode
{
  wxTWC_DASH_DEFAULT,
  wxTWC_DASH_CUSTOM,
};

enum wxTreeWndCtrlLineMode
{
  wxTWC_LINE_TOP,
  wxTWC_LINE_CENTER,
  wxTWC_LINE_BOTTOM,
...
enum wxTreeWndCtrlLineDrawMode
{
  wxTWC_LINEDRAW_NONE,
...
class APPLICATION_API wxTreeWndCtrlItem;

// ----------------------------------------------------------------------------
// globals
// ----------------------------------------------------------------------------

APPLICATION_API extern const wxTreeItemId wxTreeWndCtrlItemIdInvalid;
APPLICATION_API extern wxBitmap wxTreeWndCtrlDefaultExpand;
APPLICATION_API extern wxBitmap wxTreeWndCtrlDefaultCollapse;
APPLICATION_API extern wxPen wxTreeWndCtrlDefaultPen;

// ----------------------------------------------------------------------------
// wxTreeWndCtrl
// ----------------------------------------------------------------------------

class APPLICATION_API wxTreeWndCtrl : public wxScrolledWindow
{
    DECLARE_DYNAMIC_CLASS(wxTreeWndCtrl)

public:
    wxTreeWndCtrl();

    wxTreeWndCtrl(wxWindow *parent,
                  ...
                  wxBitmap expandedBitmap = wxTreeWndCtrlDefaultExpand,
                  wxBitmap collapsedBitmap = wxTreeWndCtrlDefaultCollapse,
                  wxPen pen = wxTreeWndCtrlDefaultPen,
                  unsigned int clickTolerance = WXTWC_DEFAULT_CLICK_TOLERANCE);

    virtual ~wxTreeWndCtrl();
    ...
    virtual wxTreeWndCtrlDashMode GetDashMode() const
        { return m_dashMode; }

    virtual void SetDashMode(wxTreeWndCtrlDashMode dashMode);

    virtual wxTreeWndCtrlLineMode GetLineMode() const
        { return m_lineMode; }

    virtual void SetLineMode(wxTreeWndCtrlLineMode lineMode);

    virtual wxTreeWndCtrlLineDrawMode GetLineDrawMode() const
        { return m_lineDrawMode; }

    virtual void SetLineDrawMode(wxTreeWndCtrlLineDrawMode lineDrawMode);

    virtual wxTreeWndCtrlToggleMode GetToggleMode() const
        { return m_toggleMode; }

    virtual void SetToggleMode(wxTreeWndCtrlToggleMode toggleMode);
...
protected:
    ...
    wxTreeWndCtrlItem* CreateTreeWndCtrlItem(const wxString &text, int image = -1, int selImage = -1);
...
protected:
    ...
    wxTreeWndCtrlDashMode m_dashMode;
    wxTreeWndCtrlLineMode m_lineMode;
    wxTreeWndCtrlLineDrawMode m_lineDrawMode;
    wxTreeWndCtrlToggleMode m_toggleMode;
    ...
    DECLARE_NO_COPY_CLASS(wxTreeWndCtrl)
};

}

#endif // _WX_TREEWNDCTRL_H_
