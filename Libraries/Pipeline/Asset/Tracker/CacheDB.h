...
namespace Asset
{
    ...
    /////////////////////////////////////////////////////////////////////////////
    PIPELINE_API typedef std::map< u64, std::string > M_CacheDBTableData;

    /////////////////////////////////////////////////////////////////////////////
    class CacheDB;
    PIPELINE_API typedef Nocturnal::SmartPtr< CacheDB > CacheDBPtr;

    /////////////////////////////////////////////////////////////////////////////
    /// class CacheDB
    /////////////////////////////////////////////////////////////////////////////
    class PIPELINE_API CacheDB : public SQL::SQLiteDB
    {
    public:
