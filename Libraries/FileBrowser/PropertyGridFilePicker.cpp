...
namespace File
{
    ...
    bool PropertyGridFilePicker::OnEvent( wxPropertyGrid* propGrid, wxWindow* primary, wxEvent& event )
    {
        ...
        if ( event.GetEventType() == wxEVT_COMMAND_BUTTON_CLICKED )
        {
            ...
            {
                handled = ShowFileDialog( propGrid, value );
            }
    ...
    // 
    bool PropertyGridFilePicker::ShowFileDialog( wxPropertyGrid* propGrid, wxString& value )
    {
        bool result = false;
        wxFileDialog openDialog( propGrid, _("Choose a file to open"), wxEmptyString, wxEmptyString, m_Filter.c_str(), wxFD_OPEN, wxDefaultPosition );

        if ( openDialog.ShowModal() == wxID_OK )
        {
            value = openDialog.GetPath().c_str();
            result = true;
        }
    ...
    bool PropertyGridFilePicker::ShowFileBrowser( wxPropertyGrid* propGrid, wxString& value )
    {
        ...
        FileBrowser fileBrowser( propGrid, wxID_ANY, m_Title.c_str() );
