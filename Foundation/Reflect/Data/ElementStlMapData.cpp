...
{
    const ElementStlMapDataT* rhs = ConstObjectCast<ElementStlMapDataT>(src);
    if (!rhs)
    {
        return false;
    }
...
{
    const ElementStlMapDataT* rhs = ConstObjectCast<ElementStlMapDataT>(s);
    if (!rhs)
    {
        return false;
    }
...
REFLECT_DEFINE_CLASS(U32ElementStlMapData);
REFLECT_DEFINE_CLASS(I32ElementStlMapData);
REFLECT_DEFINE_CLASS(U64ElementStlMapData);
REFLECT_DEFINE_CLASS(I64ElementStlMapData);
