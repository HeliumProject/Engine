...
namespace Helium
{
    namespace Simd
    {
        ...
        HELIUM_ALIGN_PRE( 16 ) class PLATFORM_API Quat
        {
        public:
            /// Identity quaternion.
...
#include "Platform/Math/Simd/Quat.inl"

#if HELIUM_SIMD_LRBNI
#include "Platform/Math/Simd/Lrbni/Quat.inl"
#elif HELIUM_SIMD_SSE
#include "Platform/Math/Simd/Sse/Quat.inl"
#endif
