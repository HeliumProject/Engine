...
void Queue::Undo()
{
  ...
  if ( m_Undo.size() > 0 && m_Undoing.RaiseWithReturn( QueueChangeArgs( this, m_Undo.back().Ptr() ) ) )
  {
...
void Queue::Redo()
{
  ...
  if ( m_Redo.size() > 0 && m_Redoing.RaiseWithReturn( QueueChangeArgs( this, m_Redo.back().Ptr() ) ) )
  {
