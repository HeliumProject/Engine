...
{
	comp.AddField(&BulletBodyDefinition::m_Shapes, "m_Shapes");
	comp.AddField(&BulletBodyDefinition::m_Restitution, "m_Restitution");
	comp.AddField(&BulletBodyDefinition::m_LinearDamping, "m_LinearDamping");
	comp.AddField(&BulletBodyDefinition::m_AngularDamping, "m_AngularDamping");
