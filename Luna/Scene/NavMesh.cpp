...
LUNA_DEFINE_TYPE( Luna::NavMesh );

D3DMATERIAL9 Luna::NavMesh::s_Material;
D3DMATERIAL9 Luna::NavMesh::s_HullMaterial;


D3DMATERIAL9 Luna::NavMesh::s_HiResVertDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_LowResVertDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_HiResEdgeDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_LowResEdgeDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_HiResTriDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_LowResTriDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_HiResTriSubDuedDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_LowResTriSubDuedDisplayMaterial;
D3DMATERIAL9 Luna::NavMesh::s_MouseOverTriMaterial;
D3DMATERIAL9 Luna::NavMesh::s_SelectedTriMaterial;
...
{
  Reflect::UnregisterClass< Luna::NavMesh >();
}
...
void NavMesh::CreatePanel( CreatePanelArgs& args )
{
  /*args.m_Generator->PushPanel( "NavMesh", true);
  {
    args.m_Generator->PushContainer();
    {
      ...
      args.m_Generator->AddChoice<Luna::Curve, int>( args.m_Selection, Reflect::Registry::GetInstance()->GetEnumeration( "CurveType" ), &Curve::GetCurveType, &Curve::SetCurveType );
    }
    ...
    args.m_Generator->PushContainer();
    {
      ...
      args.m_Generator->AddChoice<Luna::Curve, int>( args.m_Selection, Reflect::Registry::GetInstance()->GetEnumeration( "ControlPointLabel" ), &Curve::GetControlPointLabel, &Curve::SetControlPointLabel );
    }
    args.m_Generator->Pop();
