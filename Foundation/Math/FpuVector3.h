...
namespace Helium
{
    ...
    class HELIUM_FOUNDATION_API Vector3
    {
    public:
        float32_t x, y, z;
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const Vector3& vector);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, Vector3& vector);
    };
    ...
    int32_t HELIUM_FOUNDATION_API LookupPosInArray( const Vector3& pos, int32_t min_key, int32_t max_key, V_Vector3& pos_array, MM_i32& pos_lookup , float32_t threshold);
}