...
namespace Helium
{
	namespace Simd
	{
		...
		HELIUM_SIMD_ALIGN_PRE struct HELIUM_MATH_SIMD_API Matrix44 : Reflect::Struct
		{
		public:
			/// Identity matrix.
...
#endif
				/// Matrix values as a flat array.
				float32_t m_matrixAsFloatArray[ 16 ];
...
#include "MathSimd/Matrix44.inl"

#if HELIUM_SIMD_SSE
#include "MathSimd/Matrix44Sse.inl"
#endif
