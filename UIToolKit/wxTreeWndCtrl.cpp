...
UITOOLKIT_API const wxTreeItemId UIToolKit::wxTreeWndCtrlItemIdInvalid(NULL);
UITOOLKIT_API wxBitmap UIToolKit::wxTreeWndCtrlDefaultExpand( s_treeWndCtrlExpandedXpm );
UITOOLKIT_API wxBitmap UIToolKit::wxTreeWndCtrlDefaultCollapse( s_treeWndCtrlCollapsedXpm );
UITOOLKIT_API wxPen UIToolKit::wxTreeWndCtrlDefaultPen( wxColour( 0x80, 0x80, 0x80 ), 1, wxSOLID );
