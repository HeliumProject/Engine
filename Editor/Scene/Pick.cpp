...
LinePickVisitor::LinePickVisitor(const Editor::Camera* camera, const int x, const int y)
: PickVisitor (camera)
{
  camera->ViewportToLine (x, y, m_WorldSpaceLine);
}

LinePickVisitor::LinePickVisitor(const Editor::Camera* camera, const Math::Line& line)
: PickVisitor (camera)
...
FrustumPickVisitor::FrustumPickVisitor(const Editor::Camera* camera, const Math::Frustum& worldSpaceFrustum)
: PickVisitor (camera)
...
FrustumLinePickVisitor::FrustumLinePickVisitor(const Editor::Camera* camera, const Math::Line& line, const Math::Frustum& worldSpaceFrustum)
: PickVisitor(camera)
