...
igDXContent::IRBShaderLoader::IRBShaderLoader()
{
...
igDXRender::Shader* igDXContent::IRBShaderLoader::ParseFile( const char* fname, igDXRender::ShaderDatabase* db )
{
  tuid shaderId = File::GlobalManager().GetID( fname );

  if ( shaderId == TUID::Null )
  {
    printf( "WARNING: Could not locate a valid id for file '%s'.\n", fname );
    return NULL;
  }

  Asset::ShaderAssetPtr shaderClass = Asset::AssetClass::GetAssetClass< Asset::ShaderAsset >( shaderId );
...
////////////////////////////////////////////////////////////////////////////////////////////////
void igDXContent::IRBShaderLoader::SetWrapUV( igDXRender::TextureSettings* settings, u32 wrapU, u32 wrapV )
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
void igDXContent::IRBShaderLoader::SetFilter( igDXRender::TextureSettings* settings, u32 filter )
{
  settings->m_Filter = TextureFilterMode( (Asset::RunTimeFilter) filter );
}

////////////////////////////////////////////////////////////////////////////////////////////////
void igDXContent::IRBShaderLoader::SetColorFormat( igDXRender::TextureSettings* settings, u32 colorFormat, u32 mode )
{
  switch ( mode )
  {
...
////////////////////////////////////////////////////////////////////////////////////////////////
void igDXContent::IRBShaderLoader::UpdateShaderClass(igDXRender::ShaderDatabase* db, const char* shaderFilename, u32 alphaMode)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
void igDXContent::IRBShaderLoader::UpdateShaderColorMap(igDXRender::Shader* sh, const Asset::StandardColorMapAttribute* colorMap)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
void igDXContent::IRBShaderLoader::UpdateShaderNormalMap(igDXRender::Shader* sh, const Asset::StandardNormalMapAttribute* normalMap)
{
  if (!normalMap)
  {
...
////////////////////////////////////////////////////////////////////////////////////////////////
void igDXContent::IRBShaderLoader::UpdateShaderExpensiveMap(igDXRender::Shader* sh, const Asset::StandardExpensiveMapAttribute* expensiveMap)
{
  if (!expensiveMap)
  {
