...
Helium::Simd::Matrix44::Matrix44( EInitRotation, const Quat& rRotation )
{
...
Helium::Simd::Matrix44::Matrix44( EInitTranslation, const Vector3& rTranslation )
{
...
///
/// @param[in] rTranslation  Translation to set.
Helium::Simd::Matrix44::Matrix44( EInitTranslation, const Vector4& rTranslation )
{
    SetTranslation( rTranslation );
}
...
Helium::Simd::Matrix44::Matrix44( EInitScaling, float32_t scaling )
{
    SetScaling( scaling );
}
...
Helium::Simd::Matrix44::Matrix44( EInitScaling, const Vector3& rScaling )
{
    SetScaling( rScaling );
}
...
/// @param[in] rRotation     Rotation to set.
/// @param[in] rTranslation  Translation to set.
Helium::Simd::Matrix44::Matrix44( EInitRotationTranslation, const Quat& rRotation, const Vector3& rTranslation )
{
...
/// @param[in] rRotation     Rotation to set.
/// @param[in] rTranslation  Translation to set.
Helium::Simd::Matrix44::Matrix44( EInitRotationTranslation, const Quat& rRotation, const Vector4& rTranslation )
{
    SetRotationTranslation( rRotation, rTranslation );
}
...
/// @param[in] farClip   Far clip plane distance.
Helium::Simd::Matrix44::Matrix44(
    EOrthographicProjection,
    float32_t width,
    float32_t height,
    float32_t nearClip,
    float32_t farClip )
{
    SetOrthographicProjection( width, height, nearClip, farClip );
}
...
Helium::Simd::Matrix44 Helium::Simd::Matrix44::Add( const Matrix44& rMatrix ) const
{
    Matrix44 result;
...
Helium::Simd::Matrix44 Helium::Simd::Matrix44::Subtract( const Matrix44& rMatrix ) const
{
    Matrix44 result;
...
Helium::Simd::Matrix44 Helium::Simd::Matrix44::Multiply( const Matrix44& rMatrix ) const
{
    Matrix44 result;
...
Helium::Simd::Matrix44 Helium::Simd::Matrix44::MultiplyComponents( const Matrix44& rMatrix ) const
{
    Matrix44 result;
...
Helium::Simd::Matrix44 Helium::Simd::Matrix44::DivideComponents( const Matrix44& rMatrix ) const
{
    Matrix44 result;
...
///
/// @see Invert()
Helium::Simd::Matrix44 Helium::Simd::Matrix44::GetInverse() const
{
    Matrix44 result;
    GetInverse( result );
...
///
/// @see GetInverse()
void Helium::Simd::Matrix44::Invert()
{
    GetInverse( *this );
}
...
///
/// @see Transpose()
Helium::Simd::Matrix44 Helium::Simd::Matrix44::GetTranspose() const
{
    Matrix44 result;
    GetTranspose( result );
...
///
/// @see GetTranspose()
void Helium::Simd::Matrix44::Transpose()
{
    GetTranspose( *this );
}
...
Helium::Simd::Vector4 Helium::Simd::Matrix44::Transform( const Vector4& rVector ) const
{
    Vector4 result;
...
Helium::Simd::Vector3 Helium::Simd::Matrix44::TransformPoint( const Vector3& rVector ) const
{
    Vector3 result;
...
Helium::Simd::Vector3 Helium::Simd::Matrix44::TransformVector( const Vector3& rVector ) const
{
    Vector3 result;
...
///
/// @return  Matrix containing the sums of each component.
Helium::Simd::Matrix44 Helium::Simd::Matrix44::operator+( const Matrix44& rMatrix ) const
{
    return Add( rMatrix );
}
...
Helium::Simd::Matrix44& Helium::Simd::Matrix44::operator+=( const Matrix44& rMatrix )
{
    AddSet( *this, rMatrix );
...
bool Helium::Simd::Matrix44::operator==( const Matrix44& rMatrix ) const
{
