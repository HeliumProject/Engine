...
#include "Foundation/Math/SimdVector3Soa.h"
#include "Foundation/Math/SimdVector4Soa.h"
...
namespace Helium
{
    namespace Simd
    {
        ...
        HELIUM_SIMD_ALIGN_PRE class HELIUM_FOUNDATION_API Matrix44Soa
        {
        public:
            /// Identity matrix.
...
#include "Foundation/Math/SimdMatrix44Soa.inl"

#if HELIUM_SIMD_SSE
#include "Foundation/Math/SimdMatrix44SoaSse.inl"
#endif
