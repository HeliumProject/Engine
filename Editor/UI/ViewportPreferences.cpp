...
void ViewportPreferences::ApplyToViewport(Editor::Viewport* view)
{
  ...
  for(size_t i = 0; i < m_CameraPrefs.size(); ++i)
  {
    ...
    Editor::Camera* camera = view->GetCameraForMode(mode); 
...
void ViewportPreferences::LoadFromViewport(Editor::Viewport* view)
{
