...
namespace Lunar
{
    ...
    public:
        ...
        inline Vector2 GetNormalized( float32_t epsilon = L_EPSILON ) const;
        ...
        /// @name Comparison
        //@{
        inline bool Equals( const Vector2& rVector, float32_t epsilon = L_EPSILON ) const;
        //@}
