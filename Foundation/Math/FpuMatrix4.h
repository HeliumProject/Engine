...
#include "Foundation/Math/FpuScale.h"
#include "Foundation/Math/FpuShear.h"
...
namespace Helium
{
    ...
    class HELIUM_FOUNDATION_API Matrix4
    {
    public: 
        union
        {
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const Matrix4& vector);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, Matrix4& vector);
        friend class HELIUM_FOUNDATION_API Matrix3;
    };
