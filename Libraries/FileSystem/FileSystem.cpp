...
/////////////////////////////////////////////////////////////////////////////
void FileSystem::SetAttributes( const std::string& path, u32 attributes )
{
  FILESYSTEM_SCOPE_TIMER((""));

  u32 originalAttributes = 0;
  GetAttributes( path, originalAttributes );
...
/////////////////////////////////////////////////////////////////////////////
void FileSystem::ClearAttributes( const std::string& path, u32 attributes )
{
  u32 originalAttributes = 0;
  GetAttributes( path, originalAttributes );
