...
namespace Lunar
{
    ...
    const Key& ConcurrentHashMapExtractKey< Key, Data >::operator()( const std::pair< Key, Data >& rValue ) const
    {
        return rValue.first;
    }
    ...
    ConcurrentHashMap< Key, Data, HashFunction, EqualKey, Allocator >::ConcurrentHashMap( size_t bucketCount )
    ...
    template< typename Key, typename Data, typename HashFunction, typename EqualKey, typename Allocator >
    ConcurrentHashMap< Key, Data, HashFunction, EqualKey, Allocator >::ConcurrentHashMap(
    ...
    template< typename Key, typename Data, typename HashFunction, typename EqualKey, typename Allocator >
    ConcurrentHashMap< Key, Data, HashFunction, EqualKey, Allocator >&
        ConcurrentHashMap< Key, Data, HashFunction, EqualKey, Allocator >::operator=( const ConcurrentHashMap& rSource )
    {
        if( this != &rSource )
        {
