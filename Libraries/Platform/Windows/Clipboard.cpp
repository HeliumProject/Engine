...
bool Platform::CopyToClipboard( HWND owner, const std::string& data, std::string& error )
{
  bool isOk = true;
...
bool Platform::RetrieveFromClipboard( HWND owner, std::string& data, std::string& error )
{
  bool isOk = true;
