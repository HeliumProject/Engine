...
{
    Reflect::RegisterClass< Editor::Light >( TXT( "Editor::Light" ) );
...
{
    Reflect::UnregisterClass< Editor::Light >();
}

Light::Light(Editor::Scene* scene, Content::Light* light)
: Editor::Instance ( scene, light )
...
{
    const Editor::Light* light = Reflect::ConstAssertCast<Editor::Light>( object );
...
void Light::CreatePanel( CreatePanelArgs& args )
{
    ...
    args.m_Generator->PushPanel( TXT( "Light" ), true);
    {
        ...
        args.m_Generator->PushContainer();
        {
            ...
            args.m_Generator->AddColorPicker<Editor::Light, Color3>( args.m_Selection, &Light::GetPhotonColor, &Light::SetPhotonColor );

            Inspect::Slider* slider = args.m_Generator->AddSlider<Editor::Light, float>( args.m_Selection, &Light::GetPhotonIntensity, &Light::SetPhotonIntensity );
            slider->SetRangeMin( 0.0f );

            args.m_Generator->AddValue<Editor::Light, float>( args.m_Selection, &Light::GetPhotonIntensity, &Light::SetPhotonIntensity );
        }
        args.m_Generator->Pop();
        ...
        args.m_Generator->PushContainer();
        {
            ...
            args.m_Generator->AddValue<Editor::Light, u32>( args.m_Selection, &Light::GetNumPhotons, &Light::SetNumPhotons );
        }
        args.m_Generator->Pop();
        ...
        args.m_Generator->PushContainer();
        {
            ...
            args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetAttenuate, &Light::SetAttenuate );
        }
        args.m_Generator->Pop();
        ...
        args.m_Generator->PushContainer();
        {
            ...
            args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetCastsShadows, &Light::SetCastsShadows );
        }
        args.m_Generator->Pop();
        ...
        args.m_Generator->PushContainer();
        {
            ...
            Inspect::Slider* slider = args.m_Generator->AddSlider<Editor::Light, f32>( args.m_Selection, &Light::GetShadowFactor, &Light::SetShadowFactor );
            slider->SetRangeMin( 0.0f );
        ...
        args.m_Generator->PushContainer();
        {
            ...
            args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetVisibilityRayTest, &Light::SetVisibilityRayTest );
        }
        args.m_Generator->Pop();
        ...
        args.m_Generator->PushContainer();
        {
            ...
            Inspect::Choice* choice = args.m_Generator->AddChoice<Editor::Light, int>(args.m_Selection, &Light::GetRenderType, &Light::SetRenderType);
        ...
        args.m_Generator->PushContainer();
        {
            ...
            Inspect::Choice* choice = args.m_Generator->AddChoice<Editor::Light, int>(args.m_Selection, &Light::GetLensFlareType, &Light::SetLensFlareType);
            choice->SetDropDown( true );
        ...
        args.m_Generator->PushContainer();
        {
            ...
            args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetPhysicalLight, &Light::SetPhysicalLight );
        }
        args.m_Generator->Pop();
        ...
        args.m_Generator->PushPanel( TXT( "RealTime" ) );
        {
            ...
            args.m_Generator->PushContainer();
            {
                ...
                args.m_Generator->AddValue<Editor::Light, float>( args.m_Selection, &Light::GetDrawDist, &Light::SetDrawDist );
            }
            args.m_Generator->Pop();
            ...
            args.m_Generator->PushContainer();
            {
                ...
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetKillIfInactive, &Light::SetKillIfInactive );
            }
            args.m_Generator->Pop();
            ...
            args.m_Generator->PushContainer();
            {
                ...
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetAllowOversized, &Light::SetAllowOversized );
            }
            args.m_Generator->Pop();
            ...
            args.m_Generator->PushPanel( TXT( "Animation" ) );
            {
                ...
                {
                    args.m_Generator->AddLabel( TXT( "Color" ) );
                    args.m_Generator->AddKeyControl<Editor::Light>( args.m_Selection, &Reflect::CreateObject< Content::ParametricColorKey >, &Light::GetColorAnimation, &Light::SetColorAnimation );
                }
                args.m_Generator->Pop();
                ...
                args.m_Generator->PushContainer();
                {
                    ...
                    args.m_Generator->AddKeyControl<Editor::Light>( args.m_Selection, &Reflect::CreateObject< Content::ParametricColorKey >, &Light::GetIntensityAnimation, &Light::SetIntensityAnimation );
                }
                args.m_Generator->Pop();
                ...
                args.m_Generator->PushContainer();
                {
                    ...
                    args.m_Generator->AddValue<Editor::Light, float>( args.m_Selection, &Light::GetAnimationDuration, &Light::SetAnimationDuration );
                }
                args.m_Generator->Pop();
                ...
                args.m_Generator->PushContainer();
                {
                    ...
                    args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetRandomAnimOffset, &Light::SetRandomAnimOffset );
                }
                args.m_Generator->Pop();
            }
            args.m_Generator->Pop();
        ...
        args.m_Generator->PushPanel( TXT( "Selection Helper" ) );
        {
            ...
            args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetSelectionHelperLightType, &Light::SetSelectionHelperLightType );
            }
            */
            ...
            {
                args.m_Generator->AddLabel( TXT( "Render Type" ) );
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetSelectionHelperRenderType, &Light::SetSelectionHelperRenderType );
            }
            args.m_Generator->Pop();
            ...
            {
                args.m_Generator->AddLabel( TXT( "Color" ) );
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetSelectionHelperColor, &Light::SetSelectionHelperColor );
            }
            args.m_Generator->Pop();
            ...
            args.m_Generator->PushContainer();
            {
                ...
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetSelectionHelperIntensity, &Light::SetSelectionHelperIntensity );
            }
            args.m_Generator->Pop();
            ...
            args.m_Generator->PushContainer();
            {
                ...
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetSelectionHelperScale, &Light::SetSelectionHelperScale );
            }
            args.m_Generator->Pop();
            ...
            args.m_Generator->PushContainer();
            {
                ...
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetSelectionHelperLensFlare, &Light::SetSelectionHelperLensFlare );
            }
            args.m_Generator->Pop();
            ...
            {
                args.m_Generator->AddLabel( TXT( "Physical Light" ) );
                args.m_Generator->AddCheckBox<Editor::Light, bool>( args.m_Selection, &Light::GetSelectionHelperPhysicalLight, &Light::SetSelectionHelperPhysicalLight );
            }
            args.m_Generator->Pop();
        }
        args.m_Generator->Pop();
