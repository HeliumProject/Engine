...
namespace Nocturnal
{
  ...
  struct COMMON_API DirectoryItem
  {
    DirectoryItem()
      : m_CreateTime ( 0x0 )
      , m_ModTime ( 0x0 )
  ...
  COMMON_API void RecurseDirectories( DirectoryItemSignature::Delegate delegate, const std::string &path, const std::string &spec = "*.*", u32 flags = DirectoryFlags::Default);
}