...
namespace Helium
{
    ...
    class HELIUM_FOUNDATION_API Vector4
    {
    public:
        float32_t x, y, z, w;
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const Vector4& vector);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, Vector4& vector);
    };
