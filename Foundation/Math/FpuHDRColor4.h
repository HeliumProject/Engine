...
namespace Helium
{
    class HELIUM_FOUNDATION_API HDRColor4 : public Color4
    {
    public:
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const HDRColor4& color);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, HDRColor4& color);
    };
