...
namespace Maya
{
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  MAYA_API int getShadingEngineShaderId( const MObject & shadingEngine );
  ...
  ////////////////////////////////////////////////////////////////////////////////
  MAYA_API void appendShaderNames( int shader_id, MStringArray & result );
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  MAYA_API MStatus getSelectedShaderIds( const MSelectionList &selection, MIntArray & shaderIds );
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  MAYA_API MStatus getSelectedShaderEngines( const MSelectionList &selection, MObjectArray & shaderEngines );
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  MAYA_API MObject nonReferencedShadingEngine( MObject shadingEngine );
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  MAYA_API MObject makeUniqueShadingEngine( MObject &source , const MDagPath &makeUniqueFor );
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  MAYA_API void sortAndRemoveDuplicates( MIntArray & array );
}
