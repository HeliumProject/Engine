...
namespace Helium
{
    class HELIUM_FOUNDATION_API Color4
    {
    public:
        uint8_t r, g, b, a;
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const Color4& color);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, Color4& color);
    };
