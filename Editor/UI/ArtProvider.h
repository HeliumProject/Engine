...
namespace Helium
{
    namespace Editor
    {
        ...
        namespace ArtIDs
        {
            static const wxChar* NewScene = wxART_MAKE_ART_ID( EDITOR_ART_ID_NEW_SCENE );
            static const wxChar* NewEntity = wxART_MAKE_ART_ID( EDITOR_ART_ID_NEW_ENTITY );
            ...
            static const wxChar* FrustumCull = wxART_MAKE_ART_ID( EDITOR_ART_ID_FRUSTUM_CULL );
            static const wxChar* BackfaceCull = wxART_MAKE_ART_ID( EDITOR_ART_ID_BACKFACE_CULL );
            ...
            static const wxChar* Entity = wxART_MAKE_ART_ID( EDITOR_ART_ID_ENTITY );
            static const wxChar* Curve = wxART_MAKE_ART_ID( EDITOR_ART_ID_CURVE );
            static const wxChar* CurveEdit = wxART_MAKE_ART_ID( EDITOR_ART_ID_CURVEEDIT );
            static const wxChar* NavMesh = wxART_MAKE_ART_ID( EDITOR_ART_ID_NAVMESH );

            static const wxChar* AddProjectFile = wxART_MAKE_ART_ID( EDITOR_ART_ID_ADD_PROJECT_FILE );
            static const wxChar* CreateProjectFolder = wxART_MAKE_ART_ID( EDITOR_ART_ID_CREATE_PROJECT_FOLDER );
            static const wxChar* DeleteProjectItem = wxART_MAKE_ART_ID( EDITOR_ART_ID_DELETE_PROJECT_ITEM );
            ...
            static const wxChar* NewCollection = wxART_MAKE_ART_ID( EDITOR_ART_ID_NEW_COLLECTION );
            static const wxChar* DeleteCollection = wxART_MAKE_ART_ID( EDITOR_ART_ID_DELETE_COLLECTION );
