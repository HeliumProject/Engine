...
#pragma TODO( "Remove this block of code if/when wxFormBuilder supports wxArtProvider" )
    {
        ...
        m_LayerManagementToolbar->FindById( ID_CreateNewLayer )->SetNormalBitmap( wxArtProvider::GetBitmap( Luna::ArtIDs::CreateNewLayer ) );
        m_LayerManagementToolbar->FindById( ID_CreateNewLayerFromSelection )->SetNormalBitmap( wxArtProvider::GetBitmap( Luna::ArtIDs::CreateNewLayerFromSelection ) );
        m_LayerManagementToolbar->FindById( ID_DeleteSelectedLayers )->SetNormalBitmap( wxArtProvider::GetBitmap( Luna::ArtIDs::DeleteSelectedLayers ) );
        m_LayerManagementToolbar->FindById( ID_AddSelectionToLayers )->SetNormalBitmap( wxArtProvider::GetBitmap( Luna::ArtIDs::AddSelectionToLayers ) );
        m_LayerManagementToolbar->FindById( ID_RemoveSelectionFromLayers )->SetNormalBitmap( wxArtProvider::GetBitmap( Luna::ArtIDs::RemoveSelectionFromLayers ) );
        m_LayerManagementToolbar->FindById( ID_SelectLayerMembers )->SetNormalBitmap( wxArtProvider::GetBitmap( Luna::ArtIDs::SelectLayerMembers ) );
        m_LayerManagementToolbar->FindById( ID_SelectLayers )->SetNormalBitmap( wxArtProvider::GetBitmap( Luna::ArtIDs::SelectLayers ) );
...
// changed.
// 
bool LayersPanel::AddLayer( Luna::Layer* layer )
{
...
// 
bool LayersPanel::RemoveLayer( Luna::Layer* layer )
{
    //Verify this is the correct destination
    Content::Layer* cLayer = layer->GetPackage<Content::Layer>();
...
void LayersPanel::ConnectSceneListeners()
{
    if ( m_Scene )
    {
        ...
        m_Scene->AddNodeRemovedListener( NodeChangeSignature::Delegate ( this, &LayersPanel::SceneNodeRemoved ) );
...
void LayersPanel::DisconnectSceneListeners()
{
    if ( m_Scene )
    {
        ...
        m_Scene->RemoveNodeRemovedListener( NodeChangeSignature::Delegate ( this, &LayersPanel::SceneNodeRemoved ) );
...
// 
void LayersPanel::SceneNodeRemoved( const NodeChangeArgs& args )
{
    if ( args.m_Node->HasType( Reflect::GetType<Luna::Layer>() ) )
    {
