...
Luna::PersistentNode* ElementArrayNode::NewChild( Reflect::Element* element )
{
  ...
  ContextMenuItemPtr menuItemMoveUp = new ContextMenuItem( "Move Up\tAlt-UP", "Move the selected item(s) up in the list", UIToolKit::GlobalImageManager().GetBitmap( "arrow_up_16.png" ) );
  ...
  ContextMenuItemPtr menuItemMoveDown = new ContextMenuItem( "Move Down\tAlt-DOWN", "Move the selected item(s) down in the list", UIToolKit::GlobalImageManager().GetBitmap( "arrow_down_16.png" ) );
