...
VaultFrameGenerated::VaultFrameGenerated( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : Frame( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	this->Connect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( VaultFrameGenerated::OnClose ) );
}

VaultFrameGenerated::~VaultFrameGenerated()
{
	// Disconnect Events
...
SearchPanelGenerated::SearchPanelGenerated( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_VaultFoldersButton = new wxButton( m_ScrolledWindow, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	bSizer26->Add( m_VaultFoldersButton, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	m_VaultFoldersButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( SearchPanelGenerated::OnFolderBrowseButtonClick ), NULL, this );
...
SearchPanelGenerated::~SearchPanelGenerated()
{
	...
	m_VaultFoldersButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( SearchPanelGenerated::OnFolderBrowseButtonClick ), NULL, this );
...
PreviewPanelGenerated::PreviewPanelGenerated( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_PreviewWindow = new VaultPreviewWindow( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxNO_BORDER | wxFULL_REPAINT_ON_RESIZE, wxT( "Luna::PreviewWindow" ) );
