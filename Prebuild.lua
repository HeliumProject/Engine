...
Helium.Prebuild = function()
	...
	local commands =
	{
		python .. " Prebuild/JobDefParser.py JobDefinitions . .",
		python .. " Prebuild/TypeParser.py D3D9Rendering EditorSupport Engine EngineJobs Framework FrameworkWin Graphics GraphicsJobs GraphicsTypes PcSupport PreprocessingPc Rendering TestJobs WinWindowing Windowing TestApp",
