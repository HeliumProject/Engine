...
namespace Luna
{
  ...
  /// DummyThread
  /////////////////////////////////////////////////////////////////////////////
  class Luna::DummyThread : public wxThread
  {
  private:
...
bool ThreadMechanism::StartThread()
{
  ...
  m_DummyWindow->AddBeginListener( Luna::ThreadProcSignature::Delegate( this, &ThreadMechanism::OnBeginThread ) );
  m_DummyWindow->AddUpdateListener( Luna::ThreadProcSignature::Delegate( this, &ThreadMechanism::OnUpdateThread ) );
  m_DummyWindow->AddEndListener( Luna::ThreadProcSignature::Delegate( this, &ThreadMechanism::OnEndThread ) );
...
void ThreadMechanism::OnBeginThread( const Luna::ThreadProcArgs& args )
{
...
///////////////////////////////////////////////////////////////////////////////
void ThreadMechanism::OnUpdateThread( const Luna::ThreadProcArgs& args )
{
  if ( !IsCurrentThread( args.m_ThreadID ) )
    return;
}
...
///////////////////////////////////////////////////////////////////////////////
void ThreadMechanism::OnEndThread( const Luna::ThreadProcArgs& args )
{
  if ( !IsCurrentThread( args.m_ThreadID ) )
    return;
}
