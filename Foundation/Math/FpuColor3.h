...
namespace Helium
{
    ...
    class HELIUM_FOUNDATION_API Color3
    {
    public:
        uint8_t r, g, b;
        ...
        friend HELIUM_FOUNDATION_API tostream& operator<<(tostream& outStream, const Color3& color);
        friend HELIUM_FOUNDATION_API tistream& operator>>(tistream& inStream, Color3& color);
    };
