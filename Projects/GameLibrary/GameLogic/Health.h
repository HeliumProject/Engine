...
namespace GameLibrary
{
	...
	struct GAME_LIBRARY_API HealthComponent : public Helium::Component
	{
		HELIUM_DECLARE_COMPONENT( GameLibrary::HealthComponent, Helium::Component );
	...
	class GAME_LIBRARY_API HealthComponentDefinition : public Helium::ComponentDefinitionHelper<HealthComponent, HealthComponentDefinition>
	{
		HELIUM_DECLARE_CLASS( GameLibrary::HealthComponentDefinition, Helium::ComponentDefinition );
		static void PopulateMetaType( Helium::Reflect::MetaStruct& comp );
	...
	struct GAME_LIBRARY_API DoDamage : public Helium::TaskDefinition
	{
		HELIUM_DECLARE_TASK(DoDamage);
		virtual void DefineContract(Helium::TaskContract &r);
	};

	struct GAME_LIBRARY_API KillAllWithZeroHealth : public Helium::TaskDefinition
	{
