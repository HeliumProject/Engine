...
#include "UIToolKit/AutoFlexSizer.h"
...
, m_SceneEditor( sceneEditor )
{
  SetMinSize( size );
	...
	autoFlexSizer = new UIToolKit::AutoFlexSizer();
	autoFlexSizer->SetFlexibleDirection( wxBOTH );
	autoFlexSizer->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
	
#if ( 1 )

	m_button10 = new wxBitmapButton( this, wxID_ANY, UIToolKit::GlobalImageManager().GetBitmap( "asset_editor_32.png" ) );
	autoFlexSizer->Add( m_button10, 0, wxALL, 0 );

	m_button11 = new wxBitmapButton( this, wxID_ANY, UIToolKit::GlobalImageManager().GetBitmap( "create_clue_32.png" ) );
	autoFlexSizer->Add( m_button11, 0, wxALL, 0 );
	
	m_button12 = new wxBitmapButton( this, wxID_ANY, UIToolKit::GlobalImageManager().GetBitmap( "create_collision_32.png" ) );
	autoFlexSizer->Add( m_button12, 0, wxALL, 0 );
	
	m_button13 = new wxBitmapButton( this, wxID_ANY, UIToolKit::GlobalImageManager().GetBitmap( "create_controller_32.png" ) );
	autoFlexSizer->Add( m_button13, 0, wxALL, 0 );
	
	m_button14 = new wxBitmapButton( this, wxID_ANY, UIToolKit::GlobalImageManager().GetBitmap( "create_entity_32.png" ) );
	autoFlexSizer->Add( m_button14, 0, wxALL, 0 );
	
	m_button15 = new wxBitmapButton( this, wxID_ANY, UIToolKit::GlobalImageManager().GetBitmap( "create_light_32.png" ) );
	autoFlexSizer->Add( m_button15, 0, wxALL, 0 );
	
	m_button16 = new wxBitmapButton( this, wxID_ANY, UIToolKit::GlobalImageManager().GetBitmap( "create_volume_32.png" ) );
