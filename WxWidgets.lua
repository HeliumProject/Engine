...
Helium.BuildWxWidgets = function()
    ...
    elseif os.get() == "macosx" then
		...
		local flags = " --enable-monolithic --with-osx_cocoa --with-macosx-version-min=10.6 --with-macosx-sdk=/Developer/SDKs/MacOSX10.6.sdk --with-opengl --with-libjpeg=builtin --with-libpng=builtin --with-regex=builtin --with-libtiff=builtin --with-zlib=builtin --with-expat=builtin"
