...
namespace Nocturnal
{
  ...
  class APPLICATION_API Button : public wxBitmapButton
  {
  protected:
  ...
  protected:
    wxRect          m_Margins;            //<! Margins for each side of the button so we can have some space
  ...
  protected:
    ...
    bool CheckFlagValues( u32 src, u32 flags ) const;
  ...
  public:
    ...
    /// @see ButtonStyles
    virtual void        SetButtonStyle( u32 style = ButtonStyles::BU_DEFAULT );

    /// @function GetbuttonStyle
    /// @brief return the current flags that are set on t
    virtual u32 GetButtonStyle( ) const;
