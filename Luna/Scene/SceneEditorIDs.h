...
namespace Luna
{
    ...
    static ToolInfo ToolInfos[] =
    {
        ...
        { ToolModes::LocatorCreate,     wxT("Create Locator"),  Nocturnal::ArtIDs::Unknown,     wxT("Place locator objects (such as bug locators)") },
        { ToolModes::VolumeCreate,      wxT("Create Volume"),   Nocturnal::ArtIDs::Unknown,     wxT("Place volume objects (items for setting up gameplay)") },
        { ToolModes::EntityCreate,      wxT("Create Entity"),   Nocturnal::ArtIDs::Unknown,     wxT("Place entity objects (such as art instances or characters)") },
        { ToolModes::CurveCreate,       wxT("Create Curve"),    Nocturnal::ArtIDs::Unknown,     wxT("Create curve objects (Linear, B-Spline, or Catmull-Rom Spline)") },
        { ToolModes::CurveEdit,         wxT("Edit Curve"),      Nocturnal::ArtIDs::Unknown,     wxT("Edit created curves (modify or create/delete control points)") },
        { ToolModes::NavMesh,           wxT("Edit NavMesh"),    Nocturnal::ArtIDs::Unknown,     wxT("Create NavMesh or add new verts and tris") },
    };
