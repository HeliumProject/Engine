...
namespace Luna
{
  bool LUNA_CORE_API ImageManagerInit(const std::string& folder, const std::string& themeFolder = std::string( "" ));
  void LUNA_CORE_API ImageManagerCleanup();

  LUNA_CORE_API class ImageManager& GlobalImageManager();
  ...
  //
  // 
  class LUNA_CORE_API ImageManager 
  {
  public:
