...
namespace Lunar
{
    ...
    StringBase< CharType, Allocator >::StringBase()
    {
    }
    ...
    template< typename CharType, typename Allocator >
    StringBase< CharType, Allocator >::StringBase( const CharType* pString )
    {
        if( pString )
        {
    ...
    template< typename CharType, typename Allocator >
    StringBase< CharType, Allocator >::StringBase( const CharType* pString, size_t size )
    {
        if( size != 0 )
        {
    ...
    template< typename CharType, typename Allocator >
    size_t StringBase< CharType, Allocator >::GetSize() const
    {
    ...
    /// @see GetSize()
    template< typename CharType, typename Allocator >
    bool StringBase< CharType, Allocator >::IsEmpty() const
    {
    ...
    /// @see GetSize(), Reserve()
    template< typename CharType, typename Allocator >
    size_t StringBase< CharType, Allocator >::GetCapacity() const
    {
    ...
    /// @see GetCapacity()
    template< typename CharType, typename Allocator >
    void StringBase< CharType, Allocator >::Reserve( size_t capacity )
    {
        if( capacity )
        {
    ...
    /// @see GetCapacity()
    template< typename CharType, typename Allocator >
    void StringBase< CharType, Allocator >::Trim()
    {
        m_buffer.Trim();
    }
    ...
    template< typename CharType, typename Allocator >
    const CharType* StringBase< CharType, Allocator >::GetData() const
    {
    ...
    template< typename CharType, typename Allocator >
    void StringBase< CharType, Allocator >::Clear()
    {
        m_buffer.Clear();
    }
    ...
    template< typename CharType, typename Allocator >
    void StringBase< CharType, Allocator >::Add( CharType character, size_t count )
    {
        size_t bufferSize = m_buffer.GetSize();
        if( bufferSize == 0 )
        {
    ...
    template< typename CharType, typename Allocator >
    void StringBase< CharType, Allocator >::Add( const CharType* pString )
    {
        if( pString )
        {
    ...
    /// @see Pop()
    template< typename CharType, typename Allocator >
    size_t StringBase< CharType, Allocator >::Push( CharType character )
    {
        size_t bufferSize = m_buffer.GetSize();
        if( bufferSize == 0 )
        {
    ...
    template< typename CharType, typename Allocator >
    size_t StringBase< CharType, Allocator >::Find( CharType character, size_t startIndex ) const
    {
        size_t size = GetSize();
    ...
    template< typename CharType, typename Allocator >
    size_t StringBase< CharType, Allocator >::FindReverse( CharType character, size_t startIndex ) const
    {
        size_t size = GetSize();
        if( size != 0 )
        {
    ...
    template< typename CharType, typename Allocator >
    size_t StringBase< CharType, Allocator >::FindAny(
    ...
    template< typename CharType, typename Allocator >
    size_t StringBase< CharType, Allocator >::FindAnyReverse(
        const CharType* pCharacters,
        size_t startIndex,
        size_t characterCount ) const
    {
    ...
    template< typename CharType, typename Allocator >
    bool StringBase< CharType, Allocator >::Contains( CharType character ) const
    {
        size_t size = GetSize();
    ...
    bool StringBase< CharType, Allocator >::Contains( const StringBase< CharType, OtherAllocator >& rString ) const
    {
    ...
    /// @return  True if this string contains the specified string, false if not.
    template< typename CharType, typename Allocator >
    bool StringBase< CharType, Allocator >::Contains( const CharType* pString ) const
    {
        // We always contain an empty string.
        if( !pString )
        {
    ...
    template< typename CharType, typename Allocator >
    template< typename OtherAllocator >
    bool StringBase< CharType, Allocator >::StartsWith( const StringBase< CharType, OtherAllocator >& rString ) const
    {
    ...
    template< typename CharType, typename Allocator >
    template< typename OtherAllocator >
    bool StringBase< CharType, Allocator >::EndsWith( const StringBase< CharType, OtherAllocator >& rString ) const
    {
        size_t stringSize = rString.GetSize();
    ...
    void StringBase< CharType, Allocator >::Split(
    ...
    template< typename CharType, typename Allocator >
    const CharType* StringBase< CharType, Allocator >::operator*() const
    {
    ...
    template< typename CharType, typename Allocator >
    StringBase< CharType, Allocator >& StringBase< CharType, Allocator >::operator=( CharType character )
    {
        m_buffer.Clear();
        m_buffer.Reserve( 2 );
        m_buffer.Resize( 2 );
    ...
    /// @return  Reference to this string.
    template< typename CharType, typename Allocator >
    StringBase< CharType, Allocator >& StringBase< CharType, Allocator >::operator=( const CharType* pString )
    {
    ...
    template< typename CharType, typename Allocator >
    template< typename OtherAllocator >
    StringBase< CharType, Allocator >& StringBase< CharType, Allocator >::operator=(
    ...
    template< typename CharType, typename Allocator >
    bool StringBase< CharType, Allocator >::operator==( const CharType* pString ) const
    {
        size_t bufferSize = m_buffer.GetSize();
    ...
    template< typename CharType, typename Allocator >
    template< typename OtherAllocator >
    bool StringBase< CharType, Allocator >::operator==( const StringBase< CharType, OtherAllocator >& rString ) const
    {
        size_t bufferSize = m_buffer.GetSize();
    ...
    template< typename CharType, typename Allocator >
    template< typename OtherAllocator >
    void StringBase< CharType, Allocator >::Add( const StringBase< CharType, OtherAllocator >& rString )
    {
    ...
    template< typename CharType, typename Allocator >
    template< typename OtherAllocator >
    void StringBase< CharType, Allocator >::Insert(
        size_t index,
