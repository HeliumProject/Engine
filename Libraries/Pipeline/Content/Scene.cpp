...
//    }
    ...
    for each (const SkinPtr& skin in m_Skins )
    {
      ...
      for( u32 ivert = 0; ivert < num_verts; ++ivert )
      {
        ...
        for(u32 inf = 0; inf < num_weights; inf++)
        {
          ...
          Nocturnal::TUID joint_id = skin->m_InfluenceObjectIDs[influence->m_Objects[inf]];
    ...
    for( u32 contentType = 0; contentType < Content::ContentTypes::NumContentTypes; ++contentType )
    {
      ...
      for( ; itor != end; ++itor )
      {
          Nocturnal::TUID joint_id = itor->first;
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bool Scene::GetBSpheresForJoint(std::vector<t_BsphereId>& bspheres, const Nocturnal::TUID& jointID, Content::ContentType contentType ) const
  {
  ...
  void Scene::CalculateJointOrdering()
  {
    ...
    {
      if ( prim->m_ParentID == Nocturnal::TUID::Null )
      {
        continue;
      }
    ...
    {
      if ( effector->m_ParentID == Nocturnal::TUID::Null )
      {
        continue;
      }
