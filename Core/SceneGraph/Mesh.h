...
namespace Helium
{
    namespace SceneGraph
    {
        ...
        public:
            ...
            f32 SurfaceArea( Scale* scale = NULL ) const;
            ...
            f32 SurfaceAreaComponents( Vector3& areaVec ) const;

            // verts-per-meter
            f32 VertDensity() const;

            void GetEdges( S_MeshEdge& edges ) const;
            void GetTriangle( u32 triIndex, Vector3& v0, Vector3& v1, Vector3& v2, Matrix4* transform = NULL );
            ...
            u32  GetClosestTri(const Vector3& sphere_pos, const f32& sphere_rad);
            ...
            u32  GetClosestVert(const Vector3& sphere_start_pos, const f32& sphere_Rad, const Vector3& swept_dir, const f32& len);
            u32  GetClosestVert(const Matrix4& view_proj_mat, const f32 porj_space_threshold_sqr, Vector2 proj_pt);
            u32  GetClosestEdge(const Vector3& sphere_start_pos, const f32& sphere_Rad, const Vector3& swept_dir, const f32& len);
            u32  GetClosestTri(const Vector3& sphere_start_pos, const f32& sphere_rad, const Vector3& swept_dir, const f32& len);
            void PruneInvalidTris();
            void MergeVertToClosest(u32 vert_id);
            void PunchCubeHole(Matrix4& mat, Matrix4& inv_mat, f32 vert_merge_threshold);
