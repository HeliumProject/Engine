...
///////////////////////////////////////////////////////////////////////////////
VaultSearchPanel::VaultSearchPanel( VaultFrame* browserFrame, wxWindow* parent )
...
VaultSearchPanel::~VaultSearchPanel()
{
    DisconnectListners();
}
...
void VaultSearchPanel::ConnectListners()
{
    ...
    m_CollectionManager->AddChangedListener( Reflect::ElementChangeSignature::Delegate( this, &VaultSearchPanel::OnCollectionManagerChanged ) );
}

void VaultSearchPanel::DisconnectListners()
{
    //m_CollectionManager->RemoveClearAllListener( CollectionManagerSignature::Delegate( this, &VaultSearchPanel::OnCollectionManagerChanged ) );
    //m_CollectionManager->RemoveCollectionAddedListener( CollectionManagerSignature::Delegate( this, &VaultSearchPanel::OnCollectionManagerChanged ) );
    //m_CollectionManager->RemoveCollectionRemovingListener( CollectionManagerSignature::Delegate( this, &VaultSearchPanel::OnCollectionManagerChanged ) );
    m_CollectionManager->RemoveChangedListener( Reflect::ElementChangeSignature::Delegate( this, &VaultSearchPanel::OnCollectionManagerChanged ) );
}

/////////////////////////////////////////////////////////////////////////////////
bool VaultSearchPanel::Show( bool show )
{
    if ( show )
    {
...
///////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::OnFieldTextEnter( wxCommandEvent& event )
{
...
void VaultSearchPanel::OnFolderBrowseButtonClick( wxCommandEvent& event )
{
    ...
    if ( dirDialog.ShowModal() == wxID_OK )
    {
        ...
        Helium::Path::Normalize( cleanDirectory );
...
///////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::OnFieldText( wxCommandEvent& event )
{
...
///////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::OnSearchButtonClick( wxCommandEvent& event )
{
    // TODO: submit and hide the form
    if ( ProcessForm() )
    {
...
///////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::OnCancelButtonClick( wxCommandEvent& event )
{
...
/////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::OnCollectionManagerChanged( const Reflect::ElementChangeArgs& args )
{
    PopulateCollectionsChoice();
}
...
//  "PNG files (*.png)" -> "*.png"
//
void VaultSearchPanel::AddFilter( const tchar* filter )
{
...
/////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::SetFilterIndex( int filterIndex )
{
...
//
tstring VaultSearchPanel::GetFilter()
{
    tstring filter = TXT( "" );
...
//
void VaultSearchPanel::UpdateFilters()
{
...
const Filter* VaultSearchPanel::FindFilter( const tstring& name )
{
    OS_Filter::Iterator itr = m_Filters.Begin();
    OS_Filter::Iterator end = m_Filters.End();
    for ( ; itr != end; ++itr )
...
///////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::PopulateForm()
{
    DisconnectListners();
...
///////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::PopulateChoiceControl( wxControlWithItems* control, std::vector< tstring >& contents )
{
    control->Clear();
...
///////////////////////////////////////////////////////////////////////////////
void VaultSearchPanel::PopulateFileTypeChoice( std::vector< tstring >& contents )
{
    // then insert the list
    std::sort( contents.begin(), contents.end(), SortChoices() );
    std::vector< tstring >::const_iterator itr = contents.begin();
