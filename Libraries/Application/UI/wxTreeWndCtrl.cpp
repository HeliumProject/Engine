...
APPLICATION_API const wxTreeItemId Nocturnal::wxTreeWndCtrlItemIdInvalid(NULL);
APPLICATION_API wxBitmap Nocturnal::wxTreeWndCtrlDefaultExpand( s_treeWndCtrlExpandedXpm );
APPLICATION_API wxBitmap Nocturnal::wxTreeWndCtrlDefaultCollapse( s_treeWndCtrlCollapsedXpm );
APPLICATION_API wxPen Nocturnal::wxTreeWndCtrlDefaultPen( wxColour( 0x80, 0x80, 0x80 ), 1, wxSOLID );
