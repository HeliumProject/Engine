...
namespace Lunar
{
    ...
    Plane::Plane( float32_t a, float32_t b, float32_t c, float32_t d )
    {
    ...
    Plane::Plane( const Vector4& rVector )
    ...
    ///
    /// @see SetElement()
    float32_t& Plane::GetElement( size_t index )
    {
    ...
    ///
    /// @see SetElement()
    float32_t Plane::GetElement( size_t index ) const
    {
        HELIUM_ASSERT( index < 4 );
    ...
    ///
    /// @see GetElement()
    void Plane::SetElement( size_t index, float32_t value )
    {
        HELIUM_ASSERT( index < 4 );
    ...
    void Plane::Set( const Vector3& rPoint0, const Vector3& rPoint1, const Vector3& rPoint2 )
    {
    ...
    ///
    /// @see GetNormalized()
    void Plane::Normalize( float32_t epsilon )
    {
        epsilon *= epsilon;
    ...
    bool Plane::Equals( const Plane& rPlane, float32_t epsilon ) const
    {
        epsilon *= epsilon;
