...
{
  Reflect::RegisterClass< Editor::RotateManipulator >( TXT( "Editor::RotateManipulator" ) );
}

void RotateManipulator::CleanupType()
{
  Reflect::UnregisterClass< Editor::RotateManipulator >();
}

RotateManipulator::RotateManipulator(const ManipulatorMode mode, Editor::Scene* scene, PropertiesGenerator* generator)
...
void RotateManipulator::CreateProperties()
{
  ...
  m_Generator->PushPanel( TXT( "Rotate" ), true);
  {
    ...
    m_Generator->PushContainer();
    {
      ...
      m_Generator->AddValue<float>( new Helium::MemberProperty<Editor::RotateManipulator, f32> (this, &RotateManipulator::GetSnapDegrees, &RotateManipulator::SetSnapDegrees) );
    }
    m_Generator->Pop();
  }
  m_Generator->Pop();
