...
void DetailsFrame::Populate( const Helium::Path& path )
{
    ...
    if ( gotRevisionInfo && rcsFile.ExistsInDepot() )
    {
        ...
        {
      m_RevisionStatusIcon->SetBitmap( wxArtProvider::GetBitmap( Helium::ArtIDs::RCSCheckedOutByMe ) );
            m_RevisionStatus->SetLabel( TXT( "Checked out to you" ) );
        }
        else if ( rcsFile.IsCheckedOutBySomeoneElse() )
        {
      m_RevisionStatusIcon->SetBitmap( wxArtProvider::GetBitmap( Helium::ArtIDs::RCSCheckedOutBySomeoneElse ) );
        ...
        {
      m_RevisionStatusIcon->SetBitmap( wxArtProvider::GetBitmap( Helium::ArtIDs::RCSOutOfDate ) );
    ...
    m_RevisionStatusIcon->SetBitmap( wxArtProvider::GetBitmap( Helium::ArtIDs::RCSUnknown ) );
        m_LastCheckInPanel->Hide();
