...
namespace Content
{  
  typedef std::pair<UniqueID::TUID, u64> t_UidId;                                                     // uid, mesh-id pair
  ...
  typedef std::map<UniqueID::TUID, std::vector<t_BsphereId> > M_UIDBSphere;                           // map uid to (bsphere, id) list


  struct UidBsphere_t
  {
    UniqueID::TUID                            m_joint_id;
    u64                                     m_mesh_id;
