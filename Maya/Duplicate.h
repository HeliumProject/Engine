...
namespace Helium
{
    namespace Maya
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API bool duplicate( const MDagPath & sourcePath, const MDagPath & destinParent, MDagPath & resultPath, bool instanceGeometry = false, bool instanceAppropriateTransforms = false, bool allowShadersFromReferenceFile = false, bool duplicateUpstreamGraph = false );
        ...
        /// \result                               true indicates that resultPath is valid
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API bool duplicate( const MObject & sourceObj, MObject & resultObj, bool duplicateUpstreamGraph = false, bool duplicateDagNodes = false );
        ...
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API MDagPath dagPathFromSingleInstance( MObject obj );
        ...
        //
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API MDagPath parentOfPath( const MDagPath & dagPath );
        ...
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API bool retargetToSingleInstance( MFnDagNode & dagNodeFn );
        ...
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API bool retargetToChildOfParent( MFnDagNode & dagNodeFn, MFnDagNode & parentFn );
        ...
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API MDagPath childPath( MFnDagNode & nodeFn, unsigned int i,  MStatus * returnStatus = NULL );
        ...
        ////////////////////////////////////////////////////////////////////////////////
        MAYA_API MString nameWithoutNamespace( MFnDependencyNode & nodeFn );
    }
}