...
namespace Helium
{
    namespace SceneGraph
    {
        ...
        protected:
            ...
            bool AddHitSegment(const Math::Vector3& p1,const Math::Vector3& p2, float32_t mu, Math::Vector3& offset);
            bool AddHitTriangle(const Math::Vector3& v0,const Math::Vector3& v1,const Math::Vector3& v2, float32_t u, float32_t v, bool interior, Math::Vector3& vertex, Math::Vector3& intersection, float distance);
        ...
        public:
            ...
            void SetVertex(const Math::Vector3& value, float32_t distance = Math::BigFloat)
            {
                m_HasVertex = true;
        ...
        public:
            ...
            void SetIntersection(const Math::Vector3& value, float32_t distance = Math::BigFloat)
            {
