...
public:
    ...
    static void link(const litesql::Database& db, const Editor::TrackedFile& o0, const Editor::TrackedProperty& o1, tstring mValue= TXT( "" ));
    static void unlink(const litesql::Database& db, const Editor::TrackedFile& o0, const Editor::TrackedProperty& o1, tstring mValue);
...
public:
    ...
    static void link(const litesql::Database& db, const Editor::TrackedFile& o0, const Editor::TrackedFile& o1);
    static void unlink(const litesql::Database& db, const Editor::TrackedFile& o0, const Editor::TrackedFile& o1);
    static void del(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr());
    static litesql::DataSource<FileReferences::Row> getRows(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr());
    static litesql::DataSource<Editor::TrackedFile> getTrackedFile1(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr(), const litesql::Expr& srcExpr=litesql::Expr());
    static litesql::DataSource<Editor::TrackedFile> getTrackedFile2(const litesql::Database& db, const litesql::Expr& expr=litesql::Expr(), const litesql::Expr& srcExpr=litesql::Expr());
};
