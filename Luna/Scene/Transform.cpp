...
LUNA_DEFINE_TYPE( Luna::Transform );
...
{
  Reflect::UnregisterClass< Luna::Transform >();
}

Transform::Transform( Luna::Scene* scene, Content::Transform* transform ) : Luna::HierarchyNode( scene, transform )
{
...
const Luna::Transform* Transform::GetTransform() const
{
  return this;
}
...
{
  Undo::CommandPtr command = new Undo::PropertyCommand<Math::Matrix4>( new Nocturnal::MemberProperty<Luna::Transform, Math::Matrix4> (this, &Transform::GetObjectTransform, &Transform::SetObjectTransform) );
