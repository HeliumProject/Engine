...
Helium.PublishFBX = function( bin )
	...
	elseif os.get() == "macosx" then
		table.insert( files, { file="libfbxsdk-2012.2d.dylib", source=Helium.GetFbxSdkLocation() .. "/lib/gcc4", target=bin .. "/x32/Debug" } )
		table.insert( files, { file="libfbxsdk-2012.2.dylib",  source=Helium.GetFbxSdkLocation() .. "/lib/gcc4", target=bin .. "/x32/Intermediate" } )
		table.insert( files, { file="libfbxsdk-2012.2.dylib",  source=Helium.GetFbxSdkLocation() .. "/lib/gcc4", target=bin .. "/x32/Profile" } )
		table.insert( files, { file="libfbxsdk-2012.2.dylib",  source=Helium.GetFbxSdkLocation() .. "/lib/gcc4", target=bin .. "/x32/Release" }	)
	else
