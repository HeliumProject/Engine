...
SCENE_DEFINE_TYPE(Core::EntityAssetSet);

void EntityAssetSet::InitializeType()
{
    Reflect::RegisterClassType< Core::EntityAssetSet >( TXT( "Core::EntityAssetSet" ) );
}

void EntityAssetSet::CleanupType()
{
    Reflect::UnregisterClassType< Core::EntityAssetSet >();
}

EntityAssetSet::EntityAssetSet( Core::EntityType* type, const Helium::Path& assetPath )
...
void EntityAssetSet::AddInstance(Core::Instance* i)
{
...
void EntityAssetSet::RemoveInstance(Core::Instance* i)
{
