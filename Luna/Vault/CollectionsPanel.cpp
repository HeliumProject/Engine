...
{
    Nocturnal::FileDialog browserDlg( this, VaultMenu::Label( ID_OpenCollection ), TXT( "" ), TXT( "" ), TXT( "" ),
...
void CollectionsPanel::OnImportIntoCollection( wxCommandEvent& event )
{
    ...
    Nocturnal::FileDialog browserDlg( this, VaultMenu::Label( ID_ImportIntoCollection ), TXT( "" ), TXT( "" ), TXT( "" ),
        Nocturnal::FileDialogStyles::DefaultOpen | Nocturnal::FileDialogStyles::ShowAllFilesFilter | Nocturnal::FileDialogStyles::ExportFile );
...
void CollectionsPanel::OnSaveCollection( wxCommandEvent& event )
{
    ...
    if ( collection )
    {
        ...
        Nocturnal::FileDialog browserDlg( this, VaultMenu::Label( ID_SaveCollection ), defaultDir.c_str(), defaultFile.c_str(), TXT( "" ),
