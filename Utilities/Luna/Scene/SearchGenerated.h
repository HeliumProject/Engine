...
#ifndef __SearchGenerated__
#define __SearchGenerated__
...
namespace Luna
{
	...
	class SearchPanel : public wxPanel 
	{
		...
		public:
			SearchPanel( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 360,315 ), long style = wxTAB_TRAVERSAL );
			~SearchPanel();
