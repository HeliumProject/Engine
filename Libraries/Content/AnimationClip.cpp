...
////////////////////////////////////////////////////////////////////////////////////////////////
AnimationPtr AnimationClip::GetAnimationForJoint( const UniqueID::TUID& jointID )
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
CompressedAnimationPtr AnimationClip::GetCompressedAnimationForJoint( const UniqueID::TUID& jointID )
{
...
void AnimationClip::Associate( const UniqueID::TUID& jointID, const AnimationPtr& animation, bool overWrite )
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
void AnimationClip::GetJointIDs( UniqueID::V_TUID& jointIDs )
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
void AnimationClip::ApplyParentTransforms( const Content::Scene& scene, const UniqueID::TUID& targetJointId, bool zeroParents )
{
  CONTENT_SCOPE_TIMER((""));
...
////////////////////////////////////////////////////////////////////////////////////////////////
void AnimationClip::ApplyInverseParentTransforms( const Content::Scene& scene, const UniqueID::TUID& targetJointId )
{
  CONTENT_SCOPE_TIMER((""));
...
/*
  ...
  UniqueID::V_TUID::iterator jt_tuid = joint_ordering->m_JointOrdering.begin();
  UniqueID::V_TUID::iterator end_jt_tuid = joint_ordering->m_JointOrdering.end();
...
*/
  ...
  UniqueID::TUID rootId = joint_ordering->GetMasterJoint( joint_ordering->m_JointOrdering[ 0 ] );
  ...
  for(u32 frameIndex = 0; frameIndex < numSamples; ++frameIndex)
  {
    ...
    UniqueID::V_TUID::iterator it_tuid_start = joint_ordering->m_JointOrdering.begin();
    UniqueID::V_TUID::iterator it_tuid_end   = joint_ordering->m_JointOrdering.end();

    // 
    // stash scales
    //
    u32 i = 0;
    for(UniqueID::V_TUID::iterator it = it_tuid_start; it != it_tuid_end; ++it)
    {
      ...
      UniqueID::TUID masterId = joint_ordering->GetMasterJoint( *it );
...
//@@@ bad_bad_bad_bad_bad_bad_bad_bad
      ...
      UniqueID::TUID parentMasterId = joint_ordering->GetMasterJoint( parentJoint->m_ID  );
...
////////////////////////////////////////////////////////////////////////////////////////////////
void AnimationClip::RemoveTransform( const UniqueID::TUID& targetJointId, const UniqueID::TUID& referenceJointId )
{
  CONTENT_SCOPE_TIMER((""));
...
////////////////////////////////////////////////////////////////////////////////////////////////
void AnimationClip::CalculateLinearDistancePerFrame( const UniqueID::TUID &referenceJointId )
{
  CONTENT_SCOPE_TIMER((""));
...
////////////////////////////////////////////////////////////////////////////////////////////////
void AnimationClip::RemoveFirstFrameTransform( const UniqueID::TUID &targetJointId )
{
  CONTENT_SCOPE_TIMER((""));
...
void AnimationClip::RemoveRotTrans( const UniqueID::TUID& targetJointId, Math::Vector3 translation, Math::Quaternion rotation )
{
  CONTENT_SCOPE_TIMER((""));
...
void AnimationClip::DumpAnims( const JointOrderingPtr& jointOrdering )
{
  for ( u32 frame = 0; frame < WindowSamples(); ++frame )
  {
    ...
    u32 jointIndex = 0;
    UniqueID::V_TUID::iterator it = jointOrdering->m_JointOrdering.begin();
    UniqueID::V_TUID::iterator end = jointOrdering->m_JointOrdering.end();
...
u32 AnimationClip::CompressAnimations( const Content::Scene& scene, const AnimationCompressionControl& compressionControl, const JointOrderingPtr& jointOrdering, bool looping )
{
  ...
  for( ; itor != end; ++itor )
  {
    ...
    m_JointCompressedAnimationMap.insert( std::make_pair< UniqueID::TUID, CompressedAnimationPtr >( (*itor).first, compressed ) );
