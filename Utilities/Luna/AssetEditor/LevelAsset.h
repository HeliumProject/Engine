...
namespace Luna
{
  ...
  {
    Asset::LevelAssetPtr  m_LevelClass; 
  };
  ...
  // 
  class LevelAsset : public Luna::AssetClass
  {
  public:
    // Runtime Type Info
    LUNA_DECLARE_TYPE( Luna::LevelAsset, Luna::AssetClass );
    static void InitializeType();
    static void CleanupType();
    static Luna::PersistentDataPtr Create( Reflect::Element* level, Luna::AssetManager* manager );

  protected:
    LevelAsset( Asset::LevelAsset* level, Luna::AssetManager* manager ); 
  public:
    virtual ~LevelAsset(); 
