	...
	, m_Override( false )
{
	...
	// TODO: Figure out how to properly support text controls whose read only state can change
...
{
	// TODO: Can we use the Editable state instead of the read only window style employed above?
