...
class UITOOLKIT_API wxTreeWndCtrlItem;

// ----------------------------------------------------------------------------
// globals
// ----------------------------------------------------------------------------

UITOOLKIT_API extern const wxTreeItemId wxTreeWndCtrlItemIdInvalid;
UITOOLKIT_API extern wxBitmap wxTreeWndCtrlDefaultExpand;
UITOOLKIT_API extern wxBitmap wxTreeWndCtrlDefaultCollapse;
UITOOLKIT_API extern wxPen wxTreeWndCtrlDefaultPen;

// ----------------------------------------------------------------------------
// wxTreeWndCtrl
// ----------------------------------------------------------------------------

class UITOOLKIT_API wxTreeWndCtrl : public wxScrolledWindow
{
