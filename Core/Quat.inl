...
namespace Lunar
{
    ...
    Quat::Quat( const Vector3& rAxis, float32_t angle )
    {
        Set( rAxis, angle );
    }
    ...
    Quat::Quat( float32_t pitch, float32_t yaw, float32_t roll )
    {
        Set( pitch, yaw, roll );
    }
    ...
    Quat Quat::Add( const Quat& rQuat ) const
    {
        Quat result;
    ...
    Quat Quat::Subtract( const Quat& rQuat ) const
    {
        Quat result;
    ...
    Quat Quat::Multiply( const Quat& rQuat ) const
    {
        Quat result;
    ...
    Quat Quat::MultiplyComponents( const Quat& rQuat ) const
    {
        Quat result;
    ...
    Quat Quat::DivideComponents( const Quat& rQuat ) const
    {
        Quat result;
    ...
    ///
    /// @see Normalize()
    Quat Quat::GetNormalized( float32_t epsilon ) const
    {
        Quat result = *this;
    ...
    bool Quat::operator==( const Quat& rQuat ) const
    {
        return Equals( rQuat );
    }
