...
namespace Luna
{
  ...
  public:
    ThumbnailView( BrowserFrame *browserFrame, wxWindow *parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxNO_BORDER | wxFULL_REPAINT_ON_RESIZE | wxVSCROLL, const wxString& name = "Luna::ThumbnailView" );
  ...
  private:
    ...
    ThumbnailManager m_LoadManager;
