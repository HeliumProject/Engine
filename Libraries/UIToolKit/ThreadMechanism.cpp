...
namespace UIToolKit
{
  ...
  DEFINE_EVENT_TYPE( igEVT_BEGIN_THREAD )
  DEFINE_EVENT_TYPE( igEVT_UPDATE_THREAD )
  DEFINE_EVENT_TYPE( igEVT_END_THREAD )
  ...
  /// DummyThread
  /////////////////////////////////////////////////////////////////////////////
  class UIToolKit::DummyThread : public wxThread
  {
  private:
...
bool ThreadMechanism::StartThread()
{
  ...
  m_DummyWindow->Connect( m_DummyWindow->GetId(), igEVT_BEGIN_THREAD, wxCommandEventHandler( DummyWindow::OnBeginThread ), NULL, m_DummyWindow );
  m_DummyWindow->Connect( m_DummyWindow->GetId(), igEVT_UPDATE_THREAD, wxCommandEventHandler( DummyWindow::OnThreadUpdate ), NULL, m_DummyWindow );
  m_DummyWindow->Connect( m_DummyWindow->GetId(), igEVT_END_THREAD, wxCommandEventHandler( DummyWindow::OnEndThread ), NULL, m_DummyWindow );

  m_DummyWindow->AddBeginListener( UIToolKit::ThreadProcSignature::Delegate( this, &ThreadMechanism::OnBeginThread ) );
  m_DummyWindow->AddUpdateListener( UIToolKit::ThreadProcSignature::Delegate( this, &ThreadMechanism::OnUpdateThread ) );
  m_DummyWindow->AddEndListener( UIToolKit::ThreadProcSignature::Delegate( this, &ThreadMechanism::OnEndThread ) );
...
void ThreadMechanism::ThreadEnter( i32 threadID )
{
  ...
  wxCommandEvent evt( igEVT_BEGIN_THREAD, m_DummyWindow->GetId() );
  evt.SetInt( threadID );
...
{
  wxCommandEvent evt( igEVT_UPDATE_THREAD, m_DummyWindow->GetId() );
  evt.SetInt( threadID );
  wxPostEvent( m_DummyWindow, evt );
}
...
void ThreadMechanism::ThreadLeave( i32 threadID )
{
  ...
  wxCommandEvent evt( igEVT_END_THREAD, m_DummyWindow->GetId() );
  evt.SetInt( threadID );
  wxPostEvent( m_DummyWindow, evt );
  if ( m_DummyWindow )
  {
...
void ThreadMechanism::OnBeginThread( const UIToolKit::ThreadProcArgs& args )
{
...
///////////////////////////////////////////////////////////////////////////////
void ThreadMechanism::OnUpdateThread( const UIToolKit::ThreadProcArgs& args )
{
  if ( !IsCurrentThread( args.m_ThreadID ) )
    return;
}
...
///////////////////////////////////////////////////////////////////////////////
void ThreadMechanism::OnEndThread( const UIToolKit::ThreadProcArgs& args )
{
  if ( !IsCurrentThread( args.m_ThreadID ) )
    return;
}
