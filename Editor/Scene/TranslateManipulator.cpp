...
{
    Reflect::RegisterClass< Editor::TranslateManipulator >( TXT( "Editor::TranslateManipulator" ) );
}

void TranslateManipulator::CleanupType()
{
    Reflect::UnregisterClass< Editor::TranslateManipulator >();
}

TranslateManipulator::TranslateManipulator(const ManipulatorMode mode, Editor::Scene* scene, PropertiesGenerator* generator)
: Editor::TransformManipulator (mode, scene, generator)
, m_HotSnappingMode (TranslateSnappingModes::None)
, m_ShowCones (true)
, m_Factor (1.f)
{
    Editor::ScenePreferences* prefs = wxGetApp().GetPreferences()->GetScenePreferences();
