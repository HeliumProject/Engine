...
namespace Helium
{
    namespace Simd
    {
        ...
        HELIUM_SIMD_ALIGN_PRE class PLATFORM_API Matrix44Soa
        {
        public:
            /// Identity matrix.
...
#include "Platform/Math/Simd/Matrix44Soa.inl"

#if HELIUM_SIMD_LRBNI
#include "Platform/Math/Simd/Lrbni/Matrix44Soa.inl"
#elif HELIUM_SIMD_SSE
#include "Platform/Math/Simd/Sse/Matrix44Soa.inl"
#endif
