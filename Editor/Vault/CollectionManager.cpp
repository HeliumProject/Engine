...
void CollectionManager::PostDeserialize()
{
    ...
    {
        Helium::Path collectionPath( *itr );
...
bool CollectionManager::AddCollection( AssetCollection* collection )
{
    ...
    Helium::Insert<M_AssetCollections>::Result inserted = AddCollectionToMap( collection );
...
AssetCollection* CollectionManager::OpenCollection( const tstring& path, bool copyLocal )
{
    ...
    if ( loadCollection )
    {
        ...
        if ( copyLocal )
        {
            ...
            Helium::Path localPath( filePath );
        ...
        Helium::Insert<M_AssetCollections>::Result inserted = AddCollectionToMap( loadCollection );
...
///////////////////////////////////////////////////////////////////////////////
Helium::Insert<M_AssetCollections>::Result CollectionManager::AddCollectionToMap( AssetCollection* collection )
{
    Helium::Insert<M_AssetCollections>::Result inserted = m_AssetCollections.insert(
