...
namespace Asset
{
  ...
  class PIPELINE_API StandardExpensiveMapComponent : public ExpensiveMapComponent
  {
  public:
    ...
    REFLECT_DECLARE_CLASS( StandardExpensiveMapComponent, ExpensiveMapComponent );

    static void EnumerateClass( Reflect::Compositor<StandardExpensiveMapComponent>& comp );
  };

  typedef Nocturnal::SmartPtr< StandardExpensiveMapComponent > StandardExpensiveMapComponentPtr;
}